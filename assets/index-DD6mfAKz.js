...
void main() {
	...
	`}function Ed(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===lr||l===cr,d=l===ri||l===ai;if(c||d){let u=t.get(o);const f=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return e===null&&(e=new Wa(i)),u=c?e.fromEquirectangular(o,u):e.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),u.texture;if(u!==void 0)return u.texture;{const m=o.image;return c&&m&&m.height>0||d&&m&&s(m)?(e===null&&(e=new Wa(i)),u=c?e.fromEquirectangular(o):e.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function s(o){let l=0;const c=6;for(let d=0;d<c;d++)o[d]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function yd(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&ni("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function Td(i,t,e,n){const s={},r=new WeakMap;function a(u){const f=u.target;f.index!==null&&t.remove(f.index);for(const v in f.attributes)t.remove(f.attributes[v]);f.removeEventListener("dispose",a),delete s[f.id];const m=r.get(f);m&&(t.remove(m),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(u,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,e.memory.geometries++),f}function l(u){const f=u.attributes;for(const m in f)t.update(f[m],i.ARRAY_BUFFER)}function c(u){const f=[],m=u.index,v=u.attributes.position;let M=0;if(m!==null){const b=m.array;M=m.version;for(let T=0,E=b.length;T<E;T+=3){const L=b[T+0],R=b[T+1],w=b[T+2];f.push(L,R,R,w,w,L)}}else if(v!==void 0){const b=v.array;M=v.version;for(let T=0,E=b.length/3-1;T<E;T+=3){const L=T+0,R=T+1,w=T+2;f.push(L,R,R,w,w,L)}}else return;const p=new(Co(f)?No:Io)(f,1);p.version=M;const h=r.get(u);h&&t.remove(h),r.set(u,p)}function d(u){const f=r.get(u);if(f){const m=u.index;m!==null&&f.version<m.version&&c(u)}else c(u);return r.get(u)}return{get:o,update:l,getWireframeAttribute:d}}function bd(i,t,e){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function l(f,m){i.drawElements(n,m,r,f*a),e.update(m,n,1)}function c(f,m,v){v!==0&&(i.drawElementsInstanced(n,m,r,f*a,v),e.update(m,n,v))}function d(f,m,v){if(v===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,r,f,0,v);let p=0;for(let h=0;h<v;h++)p+=m[h];e.update(p,n,1)}function u(f,m,v,M){if(v===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let h=0;h<f.length;h++)c(f[h]/a,m[h],M[h]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,r,f,0,M,0,v);let h=0;for(let b=0;b<v;b++)h+=m[b]*M[b];e.update(h,n,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=d,this.renderMultiDrawInstances=u}function Ad(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(r/3);break;case i.LINES:e.lines+=o*(r/2);break;case i.LINE_STRIP:e.lines+=o*(r-1);break;case i.LINE_LOOP:e.lines+=o*r;break;case i.POINTS:e.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function wd(i,t,e){const n=new WeakMap,s=new te;function r(a,o,l){const c=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=d!==void 0?d.length:0;let f=n.get(o);if(f===void 0||f.count!==u){let x=function(){D.dispose(),n.delete(o),o.removeEventListener("dispose",x)};var m=x;f!==void 0&&f.texture.dispose();const v=o.morphAttributes.position!==void 0,M=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,h=o.morphAttributes.position||[],b=o.morphAttributes.normal||[],T=o.morphAttributes.color||[];let E=0;v===!0&&(E=1),M===!0&&(E=2),p===!0&&(E=3);let L=o.attributes.position.count*E,R=1;L>t.maxTextureSize&&(R=Math.ceil(L/t.maxTextureSize),L=t.maxTextureSize);const w=new Float32Array(L*R*4*u),D=new Po(w,L,R,u);D.type=rn,D.needsUpdate=!0;const S=E*4;for(let C=0;C<u;C++){const H=h[C],O=b[C],X=T[C],Y=L*R*4*C;for(let k=0;k<H.count;k++){const Z=k*S;v===!0&&(s.fromBufferAttribute(H,k),w[Y+Z+0]=s.x,w[Y+Z+1]=s.y,w[Y+Z+2]=s.z,w[Y+Z+3]=0),M===!0&&(s.fromBufferAttribute(O,k),w[Y+Z+4]=s.x,w[Y+Z+5]=s.y,w[Y+Z+6]=s.z,w[Y+Z+7]=0),p===!0&&(s.fromBufferAttribute(X,k),w[Y+Z+8]=s.x,w[Y+Z+9]=s.y,w[Y+Z+10]=s.z,w[Y+Z+11]=X.itemSize===4?s.w:1)}}f={count:u,texture:D,size:new wt(L,R)},n.set(o,f),o.addEventListener("dispose",x)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let v=0;for(let p=0;p<c.length;p++)v+=c[p];const M=o.morphTargetsRelative?1:1-v;l.getUniforms().setValue(i,"morphTargetBaseInfluence",M),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function Rd(i,t,e,n){let s=new WeakMap;function r(l){const c=n.render.frame,d=l.geometry,u=t.get(l,d);if(s.get(u)!==c&&(t.update(u),s.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;s.get(f)!==c&&(f.update(),s.set(f,c))}return u}function a(){s=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:r,dispose:a}}const Wo=new Ee,Ka=new Ho(1,1),Xo=new Po,qo=new Jl,Yo=new Bo,ja=[],Za=[],$a=new Float32Array(16),Ja=new Float32Array(9),Qa=new Float32Array(4);function hi(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=ja[s];if(r===void 0&&(r=new Float32Array(s),ja[s]=r),t!==0){n.toArray(r,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(r,o)}return r}function de(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function fe(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function _s(i,t){let e=Za[t];e===void 0&&(e=new Int32Array(t),Za[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function Cd(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function Pd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(de(e,t))return;i.uniform2fv(this.addr,t),fe(e,t)}}function Dd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(de(e,t))return;i.uniform3fv(this.addr,t),fe(e,t)}}function Ld(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(de(e,t))return;i.uniform4fv(this.addr,t),fe(e,t)}}function Ud(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(de(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),fe(e,t)}else{if(de(e,n))return;Qa.set(n),i.uniformMatrix2fv(this.addr,!1,Qa),fe(e,n)}}function Id(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(de(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),fe(e,t)}else{if(de(e,n))return;Ja.set(n),i.uniformMatrix3fv(this.addr,!1,Ja),fe(e,n)}}function Nd(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(de(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),fe(e,t)}else{if(de(e,n))return;$a.set(n),i.uniformMatrix4fv(this.addr,!1,$a),fe(e,n)}}function Fd(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Od(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(de(e,t))return;i.uniform2iv(this.addr,t),fe(e,t)}}function Bd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(de(e,t))return;i.uniform3iv(this.addr,t),fe(e,t)}}function zd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(de(e,t))return;i.uniform4iv(this.addr,t),fe(e,t)}}function Hd(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Vd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(de(e,t))return;i.uniform2uiv(this.addr,t),fe(e,t)}}function Gd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(de(e,t))return;i.uniform3uiv(this.addr,t),fe(e,t)}}function kd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(de(e,t))return;i.uniform4uiv(this.addr,t),fe(e,t)}}function Wd(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Ka.compareFunction=Ro,r=Ka):r=Wo,e.setTexture2D(t||r,s)}function Xd(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||qo,s)}function qd(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||Yo,s)}function Yd(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||Xo,s)}function Kd(i){switch(i){case 5126:return Cd;case 35664:return Pd;case 35665:return Dd;case 35666:return Ld;case 35674:return Ud;case 35675:return Id;case 35676:return Nd;case 5124:case 35670:return Fd;case 35667:case 35671:return Od;case 35668:case 35672:return Bd;case 35669:case 35673:return zd;case 5125:return Hd;case 36294:return Vd;case 36295:return Gd;case 36296:return kd;case 35678:case 36198:case 36298:case 36306:case 35682:return Wd;case 35679:case 36299:case 36307:return Xd;case 35680:case 36300:case 36308:case 36293:return qd;case 36289:case 36303:case 36311:case 36292:return Yd}}function jd(i,t){i.uniform1fv(this.addr,t)}function Zd(i,t){const e=hi(t,this.size,2);i.uniform2fv(this.addr,e)}function $d(i,t){const e=hi(t,this.size,3);i.uniform3fv(this.addr,e)}function Jd(i,t){const e=hi(t,this.size,4);i.uniform4fv(this.addr,e)}function Qd(i,t){const e=hi(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function tf(i,t){const e=hi(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function ef(i,t){const e=hi(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function nf(i,t){i.uniform1iv(this.addr,t)}function sf(i,t){i.uniform2iv(this.addr,t)}function rf(i,t){i.uniform3iv(this.addr,t)}function af(i,t){i.uniform4iv(this.addr,t)}function of(i,t){i.uniform1uiv(this.addr,t)}function lf(i,t){i.uniform2uiv(this.addr,t)}function cf(i,t){i.uniform3uiv(this.addr,t)}function hf(i,t){i.uniform4uiv(this.addr,t)}function uf(i,t,e){const n=this.cache,s=t.length,r=_s(e,s);de(n,r)||(i.uniform1iv(this.addr,r),fe(n,r));for(let a=0;a!==s;++a)e.setTexture2D(t[a]||Wo,r[a])}function df(i,t,e){const n=this.cache,s=t.length,r=_s(e,s);de(n,r)||(i.uniform1iv(this.addr,r),fe(n,r));for(let a=0;a!==s;++a)e.setTexture3D(t[a]||qo,r[a])}function ff(i,t,e){const n=this.cache,s=t.length,r=_s(e,s);de(n,r)||(i.uniform1iv(this.addr,r),fe(n,r));for(let a=0;a!==s;++a)e.setTextureCube(t[a]||Yo,r[a])}function pf(i,t,e){const n=this.cache,s=t.length,r=_s(e,s);de(n,r)||(i.uniform1iv(this.addr,r),fe(n,r));for(let a=0;a!==s;++a)e.setTexture2DArray(t[a]||Xo,r[a])}function mf(i){switch(i){case 5126:return jd;case 35664:return Zd;case 35665:return $d;case 35666:return Jd;case 35674:return Qd;case 35675:return tf;case 35676:return ef;case 5124:case 35670:return nf;case 35667:case 35671:return sf;case 35668:case 35672:return rf;case 35669:case 35673:return af;case 5125:return of;case 36294:return lf;case 36295:return cf;case 36296:return hf;case 35678:case 36198:case 36298:case 36306:case 35682:return uf;case 35679:case 36299:case 36307:return df;case 35680:case 36300:case 36308:case 36293:return ff;case 36289:case 36303:case 36311:case 36292:return pf}}class _f{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Kd(e.type)}}class gf{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=mf(e.type)}}class vf{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(t,e[o.id],n)}}}const $s=/(\w+)(\])?(\[|\.)?/g;function to(i,t){i.seq.push(t),i.map[t.id]=t}function xf(i,t,e){const n=i.name,s=n.length;for($s.lastIndex=0;;){const r=$s.exec(n),a=$s.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){to(e,c===void 0?new _f(o,i,t):new gf(o,i,t));break}else{let u=e.map[o];u===void 0&&(u=new vf(o),to(e,u)),e=u}}}class os{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=t.getActiveUniform(e,s),a=t.getUniformLocation(e,r.name);xf(r,a,this)}}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,a=e.length;r!==a;++r){const o=e[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const a=t[s];a.id in e&&n.push(a)}return n}}function eo(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const Mf=37297;let Sf=0;function Ef(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}const no=new Bt;function yf(i){Yt._getMatrix(no,Yt.workingColorSpace,i);const t=`mat3( ${no.elements.map(e=>e.toFixed(4))} )`;switch(Yt.getTransfer(i)){case cs:return[t,"LinearTransferOETF"];case Jt:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function io(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),s=i.getShaderInfoLog(t).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const a=parseInt(r[1]);return e.toUpperCase()+`
...
`)+`
`+h);const T=b+p+a,E=b+h+o,L=eo(s,s.VERTEX_SHADER,T),R=eo(s,s.FRAGMENT_SHADER,E);s.attachShader(M,L),s.attachShader(M,R),e.index0AttributeName!==void 0?s.bindAttribLocation(M,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function w(C){if(i.debug.checkShaderErrors){const H=s.getProgramInfoLog(M).trim(),O=s.getShaderInfoLog(L).trim(),X=s.getShaderInfoLog(R).trim();let Y=!0,k=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(Y=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,L,R);else{const Z=io(s,L,"vertex"),V=io(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
}`;function np(i,t,e){let n=new $r;const s=new wt,r=new wt,a=new te,o=new yc({depthPacking:Ll}),l=new Tc,c={},d=e.maxTextureSize,u={[vn]:we,[we]:vn,[Ve]:Ve},f=new xn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new wt},radius:{value:4}},vertexShader:tp,fragmentShader:ep}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const v=new Fe;v.setAttribute("position",new Xe(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Se(v,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=mo;let h=this.type;this.render=function(R,w,D){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||R.length===0)return;const S=i.getRenderTarget(),x=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),H=i.state;H.setBlending(_n),H.buffers.color.setClear(1,1,1,1),H.buffers.depth.setTest(!0),H.setScissorTest(!1);const O=h!==nn&&this.type===nn,X=h===nn&&this.type!==nn;for(let Y=0,k=R.length;Y<k;Y++){const Z=R[Y],V=Z.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);const rt=V.getFrameExtents();if(s.multiply(rt),r.copy(V.mapSize),(s.x>d||s.y>d)&&(s.x>d&&(r.x=Math.floor(d/rt.x),s.x=r.x*rt.x,V.mapSize.x=r.x),s.y>d&&(r.y=Math.floor(d/rt.y),s.y=r.y*rt.y,V.mapSize.y=r.y)),V.map===null||O===!0||X===!0){const yt=this.type!==nn?{minFilter:We,magFilter:We}:{};V.map!==null&&V.map.dispose(),V.map=new Nn(s.x,s.y,yt),V.map.texture.name=Z.name+".shadowMap",V.camera.updateProjectionMatrix()}i.setRenderTarget(V.map),i.clear();const ut=V.getViewportCount();for(let yt=0;yt<ut;yt++){const Nt=V.getViewport(yt);a.set(r.x*Nt.x,r.y*Nt.y,r.x*Nt.z,r.y*Nt.w),H.viewport(a),V.updateMatrices(Z,yt),n=V.getFrustum(),E(w,D,V.camera,Z,this.type)}V.isPointLightShadow!==!0&&this.type===nn&&b(V,D),V.needsUpdate=!1}h=this.type,p.needsUpdate=!1,i.setRenderTarget(S,x,C)};function b(R,w){const D=t.update(M);f.defines.VSM_SAMPLES!==R.blurSamples&&(f.defines.VSM_SAMPLES=R.blurSamples,m.defines.VSM_SAMPLES=R.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Nn(s.x,s.y)),f.uniforms.shadow_pass.value=R.map.texture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(w,null,D,f,M,null),m.uniforms.shadow_pass.value=R.mapPass.texture,m.uniforms.resolution.value=R.mapSize,m.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(w,null,D,m,M,null)}function T(R,w,D,S){let x=null;const C=D.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(C!==void 0)x=C;else if(x=D.isPointLight===!0?l:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const H=x.uuid,O=w.uuid;let X=c[H];X===void 0&&(X={},c[H]=X);let Y=X[O];Y===void 0&&(Y=x.clone(),X[O]=Y,w.addEventListener("dispose",L)),x=Y}if(x.visible=w.visible,x.wireframe=w.wireframe,S===nn?x.side=w.shadowSide!==null?w.shadowSide:w.side:x.side=w.shadowSide!==null?w.shadowSide:u[w.side],x.alphaMap=w.alphaMap,x.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,x.map=w.map,x.clipShadows=w.clipShadows,x.clippingPlanes=w.clippingPlanes,x.clipIntersection=w.clipIntersection,x.displacementMap=w.displacementMap,x.displacementScale=w.displacementScale,x.displacementBias=w.displacementBias,x.wireframeLinewidth=w.wireframeLinewidth,x.linewidth=w.linewidth,D.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const H=i.properties.get(x);H.light=D}return x}function E(R,w,D,S,x){if(R.visible===!1)return;if(R.layers.test(w.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&x===nn)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,R.matrixWorld);const O=t.update(R),X=R.material;if(Array.isArray(X)){const Y=O.groups;for(let k=0,Z=Y.length;k<Z;k++){const V=Y[k],rt=X[V.materialIndex];if(rt&&rt.visible){const ut=T(R,rt,S,x);R.onBeforeShadow(i,R,w,D,O,ut,V),i.renderBufferDirect(D,null,O,ut,R,V),R.onAfterShadow(i,R,w,D,O,ut,V)}}}else if(X.visible){const Y=T(R,X,S,x);R.onBeforeShadow(i,R,w,D,O,Y,null),i.renderBufferDirect(D,null,O,Y,R,null),R.onAfterShadow(i,R,w,D,O,Y,null)}}const H=R.children;for(let O=0,X=H.length;O<X;O++)E(H[O],w,D,S,x)}function L(R){R.target.removeEventListener("dispose",L);for(const D in c){const S=c[D],x=R.target.uuid;x in S&&(S[x].dispose(),delete S[x])}}}const ip={[er]:nr,[ir]:ar,[sr]:or,[si]:rr,[nr]:er,[ar]:ir,[or]:sr,[rr]:si};function sp(i,t){function e(){let P=!1;const ct=new te;let J=null;const pt=new te(0,0,0,0);return{setMask:function(Q){J!==Q&&!P&&(i.colorMask(Q,Q,Q,Q),J=Q)},setLocked:function(Q){P=Q},setClear:function(Q,K,mt,Ot,ne){ne===!0&&(Q*=Ot,K*=Ot,mt*=Ot),ct.set(Q,K,mt,Ot),pt.equals(ct)===!1&&(i.clearColor(Q,K,mt,Ot),pt.copy(ct))},reset:function(){P=!1,J=null,pt.set(-1,0,0,0)}}}function n(){let P=!1,ct=!1,J=null,pt=null,Q=null;return{setReversed:function(K){if(ct!==K){const mt=t.get("EXT_clip_control");K?mt.clipControlEXT(mt.LOWER_LEFT_EXT,mt.ZERO_TO_ONE_EXT):mt.clipControlEXT(mt.LOWER_LEFT_EXT,mt.NEGATIVE_ONE_TO_ONE_EXT),ct=K;const Ot=Q;Q=null,this.setClear(Ot)}},getReversed:function(){return ct},setTest:function(K){K?lt(i.DEPTH_TEST):Mt(i.DEPTH_TEST)},setMask:function(K){J!==K&&!P&&(i.depthMask(K),J=K)},setFunc:function(K){if(ct&&(K=ip[K]),pt!==K){switch(K){case er:i.depthFunc(i.NEVER);break;case nr:i.depthFunc(i.ALWAYS);break;case ir:i.depthFunc(i.LESS);break;case si:i.depthFunc(i.LEQUAL);break;case sr:i.depthFunc(i.EQUAL);break;case rr:i.depthFunc(i.GEQUAL);break;case ar:i.depthFunc(i.GREATER);break;case or:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}pt=K}},setLocked:function(K){P=K},setClear:function(K){Q!==K&&(ct&&(K=1-K),i.clearDepth(K),Q=K)},reset:function(){P=!1,J=null,pt=null,Q=null,ct=!1}}}function s(){let P=!1,ct=null,J=null,pt=null,Q=null,K=null,mt=null,Ot=null,ne=null;return{setTest:function(Zt){P||(Zt?lt(i.STENCIL_TEST):Mt(i.STENCIL_TEST))},setMask:function(Zt){ct!==Zt&&!P&&(i.stencilMask(Zt),ct=Zt)},setFunc:function(Zt,Oe,Ze){(J!==Zt||pt!==Oe||Q!==Ze)&&(i.stencilFunc(Zt,Oe,Ze),J=Zt,pt=Oe,Q=Ze)},setOp:function(Zt,Oe,Ze){(K!==Zt||mt!==Oe||Ot!==Ze)&&(i.stencilOp(Zt,Oe,Ze),K=Zt,mt=Oe,Ot=Ze)},setLocked:function(Zt){P=Zt},setClear:function(Zt){ne!==Zt&&(i.clearStencil(Zt),ne=Zt)},reset:function(){P=!1,ct=null,J=null,pt=null,Q=null,K=null,mt=null,Ot=null,ne=null}}}const r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let d={},u={},f=new WeakMap,m=[],v=null,M=!1,p=null,h=null,b=null,T=null,E=null,L=null,R=null,w=new kt(0,0,0),D=0,S=!1,x=null,C=null,H=null,O=null,X=null;const Y=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,Z=0;const V=i.getParameter(i.VERSION);V.indexOf("WebGL")!==-1?(Z=parseFloat(/^WebGL (\d)/.exec(V)[1]),k=Z>=1):V.indexOf("OpenGL ES")!==-1&&(Z=parseFloat(/^OpenGL ES (\d)/.exec(V)[1]),k=Z>=2);let rt=null,ut={};const yt=i.getParameter(i.SCISSOR_BOX),Nt=i.getParameter(i.VIEWPORT),Kt=new te().fromArray(yt),W=new te().fromArray(Nt);function et(P,ct,J,pt){const Q=new Uint8Array(4),K=i.createTexture();i.bindTexture(P,K),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let mt=0;mt<J;mt++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(ct,0,i.RGBA,1,1,pt,0,i.RGBA,i.UNSIGNED_BYTE,Q):i.texImage2D(ct+mt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Q);return K}const vt={};vt[i.TEXTURE_2D]=et(i.TEXTURE_2D,i.TEXTURE_2D,1),vt[i.TEXTURE_CUBE_MAP]=et(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),vt[i.TEXTURE_2D_ARRAY]=et(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),vt[i.TEXTURE_3D]=et(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),lt(i.DEPTH_TEST),a.setFunc(si),Gt(!1),jt(ca),lt(i.CULL_FACE),A(_n);function lt(P){d[P]!==!0&&(i.enable(P),d[P]=!0)}function Mt(P){d[P]!==!1&&(i.disable(P),d[P]=!1)}function nt(P,ct){return u[P]!==ct?(i.bindFramebuffer(P,ct),u[P]=ct,P===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=ct),P===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=ct),!0):!1}function at(P,ct){let J=m,pt=!1;if(P){J=f.get(ct),J===void 0&&(J=[],f.set(ct,J));const Q=P.textures;if(J.length!==Q.length||J[0]!==i.COLOR_ATTACHMENT0){for(let K=0,mt=Q.length;K<mt;K++)J[K]=i.COLOR_ATTACHMENT0+K;J.length=Q.length,pt=!0}}else J[0]!==i.BACK&&(J[0]=i.BACK,pt=!0);pt&&i.drawBuffers(J)}function Pt(P){return v!==P?(i.useProgram(P),v=P,!0):!1}const Ft={[Cn]:i.FUNC_ADD,[rl]:i.FUNC_SUBTRACT,[al]:i.FUNC_REVERSE_SUBTRACT};Ft[ol]=i.MIN,Ft[ll]=i.MAX;const Lt={[cl]:i.ZERO,[hl]:i.ONE,[ul]:i.SRC_COLOR,[Qs]:i.SRC_ALPHA,[gl]:i.SRC_ALPHA_SATURATE,[ml]:i.DST_COLOR,[fl]:i.DST_ALPHA,[dl]:i.ONE_MINUS_SRC_COLOR,[tr]:i.ONE_MINUS_SRC_ALPHA,[_l]:i.ONE_MINUS_DST_COLOR,[pl]:i.ONE_MINUS_DST_ALPHA,[vl]:i.CONSTANT_COLOR,[xl]:i.ONE_MINUS_CONSTANT_COLOR,[Ml]:i.CONSTANT_ALPHA,[Sl]:i.ONE_MINUS_CONSTANT_ALPHA};function A(P,ct,J,pt,Q,K,mt,Ot,ne,Zt){if(P===_n){M===!0&&(Mt(i.BLEND),M=!1);return}if(M===!1&&(lt(i.BLEND),M=!0),P!==sl){if(P!==p||Zt!==S){if((h!==Cn||E!==Cn)&&(i.blendEquation(i.FUNC_ADD),h=Cn,E=Cn),Zt)switch(P){case ei:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ha:i.blendFunc(i.ONE,i.ONE);break;case ua:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case da:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case ei:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ha:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case ua:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case da:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}b=null,T=null,L=null,R=null,w.set(0,0,0),D=0,p=P,S=Zt}return}Q=Q||ct,K=K||J,mt=mt||pt,(ct!==h||Q!==E)&&(i.blendEquationSeparate(Ft[ct],Ft[Q]),h=ct,E=Q),(J!==b||pt!==T||K!==L||mt!==R)&&(i.blendFuncSeparate(Lt[J],Lt[pt],Lt[K],Lt[mt]),b=J,T=pt,L=K,R=mt),(Ot.equals(w)===!1||ne!==D)&&(i.blendColor(Ot.r,Ot.g,Ot.b,ne),w.copy(Ot),D=ne),p=P,S=!1}function se(P,ct){P.side===Ve?Mt(i.CULL_FACE):lt(i.CULL_FACE);let J=P.side===we;ct&&(J=!J),Gt(J),P.blending===ei&&P.transparent===!1?A(_n):A(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),r.setMask(P.colorWrite);const pt=P.stencilWrite;o.setTest(pt),pt&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),Xt(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?lt(i.SAMPLE_ALPHA_TO_COVERAGE):Mt(i.SAMPLE_ALPHA_TO_COVERAGE)}function Gt(P){x!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),x=P)}function jt(P){P!==el?(lt(i.CULL_FACE),P!==C&&(P===ca?i.cullFace(i.BACK):P===nl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Mt(i.CULL_FACE),C=P}function gt(P){P!==H&&(k&&i.lineWidth(P),H=P)}function Xt(P,ct,J){P?(lt(i.POLYGON_OFFSET_FILL),(O!==ct||X!==J)&&(i.polygonOffset(ct,J),O=ct,X=J)):Mt(i.POLYGON_OFFSET_FILL)}function bt(P){P?lt(i.SCISSOR_TEST):Mt(i.SCISSOR_TEST)}function zt(P){P===void 0&&(P=i.TEXTURE0+Y-1),rt!==P&&(i.activeTexture(P),rt=P)}function he(P,ct,J){J===void 0&&(rt===null?J=i.TEXTURE0+Y-1:J=rt);let pt=ut[J];pt===void 0&&(pt={type:void 0,texture:void 0},ut[J]=pt),(pt.type!==P||pt.texture!==ct)&&(rt!==J&&(i.activeTexture(J),rt=J),i.bindTexture(P,ct||vt[P]),pt.type=P,pt.texture=ct)}function y(){const P=ut[rt];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function _(){try{i.compressedTexImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function F(){try{i.compressedTexImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function q(){try{i.texSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function j(){try{i.texSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function G(){try{i.compressedTexSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function St(){try{i.compressedTexSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ot(){try{i.texStorage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function xt(){try{i.texStorage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Et(){try{i.texImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function $(){try{i.texImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function dt(P){Kt.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),Kt.copy(P))}function Ct(P){W.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),W.copy(P))}function Rt(P,ct){let J=c.get(ct);J===void 0&&(J=new WeakMap,c.set(ct,J));let pt=J.get(P);pt===void 0&&(pt=i.getUniformBlockIndex(ct,P.name),J.set(P,pt))}function it(P,ct){const pt=c.get(ct).get(P);l.get(ct)!==pt&&(i.uniformBlockBinding(ct,pt,P.__bindingPointIndex),l.set(ct,pt))}function It(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),d={},rt=null,ut={},u={},f=new WeakMap,m=[],v=null,M=!1,p=null,h=null,b=null,T=null,E=null,L=null,R=null,w=new kt(0,0,0),D=0,S=!1,x=null,C=null,H=null,O=null,X=null,Kt.set(0,0,i.canvas.width,i.canvas.height),W.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:lt,disable:Mt,bindFramebuffer:nt,drawBuffers:at,useProgram:Pt,setBlending:A,setMaterial:se,setFlipSided:Gt,setCullFace:jt,setLineWidth:gt,setPolygonOffset:Xt,setScissorTest:bt,activeTexture:zt,bindTexture:he,unbindTexture:y,compressedTexImage2D:_,compressedTexImage3D:F,texImage2D:Et,texImage3D:$,updateUBOMapping:Rt,uniformBlockBinding:it,texStorage2D:ot,texStorage3D:xt,texSubImage2D:q,texSubImage3D:j,compressedTexSubImage2D:G,compressedTexSubImage3D:St,scissor:dt,viewport:Ct,reset:It}}function rp(i,t,e,n,s,r,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new wt,d=new WeakMap;let u;const f=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(y,_){return m?new OffscreenCanvas(y,_):us("canvas")}function M(y,_,F){let q=1;const j=he(y);if((j.width>F||j.height>F)&&(q=F/Math.max(j.width,j.height)),q<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const G=Math.floor(q*j.width),St=Math.floor(q*j.height);u===void 0&&(u=v(G,St));const ot=_?v(G,St):u;return ot.width=G,ot.height=St,ot.getContext("2d").drawImage(y,0,0,G,St),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+G+"x"+St+")."),ot}else return"data"in y&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),y;return y}function p(y){return y.generateMipmaps}function h(y){i.generateMipmap(y)}function b(y){return y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:y.isWebGL3DRenderTarget?i.TEXTURE_3D:y.isWebGLArrayRenderTarget||y.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(y,_,F,q,j=!1){if(y!==null){if(i[y]!==void 0)return i[y];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let G=_;if(_===i.RED&&(F===i.FLOAT&&(G=i.R32F),F===i.HALF_FLOAT&&(G=i.R16F),F===i.UNSIGNED_BYTE&&(G=i.R8)),_===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(G=i.R8UI),F===i.UNSIGNED_SHORT&&(G=i.R16UI),F===i.UNSIGNED_INT&&(G=i.R32UI),F===i.BYTE&&(G=i.R8I),F===i.SHORT&&(G=i.R16I),F===i.INT&&(G=i.R32I)),_===i.RG&&(F===i.FLOAT&&(G=i.RG32F),F===i.HALF_FLOAT&&(G=i.RG16F),F===i.UNSIGNED_BYTE&&(G=i.RG8)),_===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(G=i.RG8UI),F===i.UNSIGNED_SHORT&&(G=i.RG16UI),F===i.UNSIGNED_INT&&(G=i.RG32UI),F===i.BYTE&&(G=i.RG8I),F===i.SHORT&&(G=i.RG16I),F===i.INT&&(G=i.RG32I)),_===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(G=i.RGB8UI),F===i.UNSIGNED_SHORT&&(G=i.RGB16UI),F===i.UNSIGNED_INT&&(G=i.RGB32UI),F===i.BYTE&&(G=i.RGB8I),F===i.SHORT&&(G=i.RGB16I),F===i.INT&&(G=i.RGB32I)),_===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(G=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(G=i.RGBA16UI),F===i.UNSIGNED_INT&&(G=i.RGBA32UI),F===i.BYTE&&(G=i.RGBA8I),F===i.SHORT&&(G=i.RGBA16I),F===i.INT&&(G=i.RGBA32I)),_===i.RGB&&F===i.UNSIGNED_INT_5_9_9_9_REV&&(G=i.RGB9_E5),_===i.RGBA){const St=j?cs:Yt.getTransfer(q);F===i.FLOAT&&(G=i.RGBA32F),F===i.HALF_FLOAT&&(G=i.RGBA16F),F===i.UNSIGNED_BYTE&&(G=St===Jt?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(G=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(G=i.RGB5_A1)}return(G===i.R16F||G===i.R32F||G===i.RG16F||G===i.RG32F||G===i.RGBA16F||G===i.RGBA32F)&&t.get("EXT_color_buffer_float"),G}function E(y,_){let F;return y?_===null||_===Un||_===Si?F=i.DEPTH24_STENCIL8:_===rn?F=i.DEPTH32F_STENCIL8:_===Mi&&(F=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Un||_===Si?F=i.DEPTH_COMPONENT24:_===rn?F=i.DEPTH_COMPONENT32F:_===Mi&&(F=i.DEPTH_COMPONENT16),F}function L(y,_){return p(y)===!0||y.isFramebufferTexture&&y.minFilter!==We&&y.minFilter!==Ye?Math.log2(Math.max(_.width,_.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?_.mipmaps.length:1}function R(y){const _=y.target;_.removeEventListener("dispose",R),D(_),_.isVideoTexture&&d.delete(_)}function w(y){const _=y.target;_.removeEventListener("dispose",w),x(_)}function D(y){const _=n.get(y);if(_.__webglInit===void 0)return;const F=y.source,q=f.get(F);if(q){const j=q[_.__cacheKey];j.usedTimes--,j.usedTimes===0&&S(y),Object.keys(q).length===0&&f.delete(F)}n.remove(y)}function S(y){const _=n.get(y);i.deleteTexture(_.__webglTexture);const F=y.source,q=f.get(F);delete q[_.__cacheKey],a.memory.textures--}function x(y){const _=n.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),n.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(_.__webglFramebuffer[q]))for(let j=0;j<_.__webglFramebuffer[q].length;j++)i.deleteFramebuffer(_.__webglFramebuffer[q][j]);else i.deleteFramebuffer(_.__webglFramebuffer[q]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[q])}else{if(Array.isArray(_.__webglFramebuffer))for(let q=0;q<_.__webglFramebuffer.length;q++)i.deleteFramebuffer(_.__webglFramebuffer[q]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let q=0;q<_.__webglColorRenderbuffer.length;q++)_.__webglColorRenderbuffer[q]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[q]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const F=y.textures;for(let q=0,j=F.length;q<j;q++){const G=n.get(F[q]);G.__webglTexture&&(i.deleteTexture(G.__webglTexture),a.memory.textures--),n.remove(F[q])}n.remove(y)}let C=0;function H(){C=0}function O(){const y=C;return y>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+s.maxTextures),C+=1,y}function X(y){const _=[];return _.push(y.wrapS),_.push(y.wrapT),_.push(y.wrapR||0),_.push(y.magFilter),_.push(y.minFilter),_.push(y.anisotropy),_.push(y.internalFormat),_.push(y.format),_.push(y.type),_.push(y.generateMipmaps),_.push(y.premultiplyAlpha),_.push(y.flipY),_.push(y.unpackAlignment),_.push(y.colorSpace),_.join()}function Y(y,_){const F=n.get(y);if(y.isVideoTexture&&bt(y),y.isRenderTargetTexture===!1&&y.version>0&&F.__version!==y.version){const q=y.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{vt(F,y,_);return}}e.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+_)}function k(y,_){const F=n.get(y);if(y.version>0&&F.__version!==y.version){vt(F,y,_);return}e.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+_)}function Z(y,_){const F=n.get(y);if(y.version>0&&F.__version!==y.version){vt(F,y,_);return}e.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+_)}function V(y,_){const F=n.get(y);if(y.version>0&&F.__version!==y.version){lt(F,y,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+_)}const rt={[ls]:i.REPEAT,[Dn]:i.CLAMP_TO_EDGE,[hr]:i.MIRRORED_REPEAT},ut={[We]:i.NEAREST,[Pl]:i.NEAREST_MIPMAP_NEAREST,[Pi]:i.NEAREST_MIPMAP_LINEAR,[Ye]:i.LINEAR,[xs]:i.LINEAR_MIPMAP_NEAREST,[Ln]:i.LINEAR_MIPMAP_LINEAR},yt={[Il]:i.NEVER,[Hl]:i.ALWAYS,[Nl]:i.LESS,[Ro]:i.LEQUAL,[Fl]:i.EQUAL,[zl]:i.GEQUAL,[Ol]:i.GREATER,[Bl]:i.NOTEQUAL};function Nt(y,_){if(_.type===rn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===Ye||_.magFilter===xs||_.magFilter===Pi||_.magFilter===Ln||_.minFilter===Ye||_.minFilter===xs||_.minFilter===Pi||_.minFilter===Ln)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(y,i.TEXTURE_WRAP_S,rt[_.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,rt[_.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,rt[_.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,ut[_.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,ut[_.minFilter]),_.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,yt[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===We||_.minFilter!==Pi&&_.minFilter!==Ln||_.type===rn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const F=t.get("EXT_texture_filter_anisotropic");i.texParameterf(y,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Kt(y,_){let F=!1;y.__webglInit===void 0&&(y.__webglInit=!0,_.addEventListener("dispose",R));const q=_.source;let j=f.get(q);j===void 0&&(j={},f.set(q,j));const G=X(_);if(G!==y.__cacheKey){j[G]===void 0&&(j[G]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,F=!0),j[G].usedTimes++;const St=j[y.__cacheKey];St!==void 0&&(j[y.__cacheKey].usedTimes--,St.usedTimes===0&&S(_)),y.__cacheKey=G,y.__webglTexture=j[G].texture}return F}function W(y,_,F){return Math.floor(Math.floor(y/F)/_)}function et(y,_,F,q){const G=y.updateRanges;if(G.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,F,q,_.data);else{G.sort(($,dt)=>$.start-dt.start);let St=0;for(let $=1;$<G.length;$++){const dt=G[St],Ct=G[$],Rt=dt.start+dt.count,it=W(Ct.start,_.width,4),It=W(dt.start,_.width,4);Ct.start<=Rt+1&&it===It&&W(Ct.start+Ct.count-1,_.width,4)===it?dt.count=Math.max(dt.count,Ct.start+Ct.count-dt.start):(++St,G[St]=Ct)}G.length=St+1;const ot=i.getParameter(i.UNPACK_ROW_LENGTH),xt=i.getParameter(i.UNPACK_SKIP_PIXELS),Et=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let $=0,dt=G.length;$<dt;$++){const Ct=G[$],Rt=Math.floor(Ct.start/4),it=Math.ceil(Ct.count/4),It=Rt%_.width,P=Math.floor(Rt/_.width),ct=it,J=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,It),i.pixelStorei(i.UNPACK_SKIP_ROWS,P),e.texSubImage2D(i.TEXTURE_2D,0,It,P,ct,J,F,q,_.data)}y.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ot),i.pixelStorei(i.UNPACK_SKIP_PIXELS,xt),i.pixelStorei(i.UNPACK_SKIP_ROWS,Et)}}function vt(y,_,F){let q=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(q=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(q=i.TEXTURE_3D);const j=Kt(y,_),G=_.source;e.bindTexture(q,y.__webglTexture,i.TEXTURE0+F);const St=n.get(G);if(G.version!==St.__version||j===!0){e.activeTexture(i.TEXTURE0+F);const ot=Yt.getPrimaries(Yt.workingColorSpace),xt=_.colorSpace===mn?null:Yt.getPrimaries(_.colorSpace),Et=_.colorSpace===mn||ot===xt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Et);let $=M(_.image,!1,s.maxTextureSize);$=zt(_,$);const dt=r.convert(_.format,_.colorSpace),Ct=r.convert(_.type);let Rt=T(_.internalFormat,dt,Ct,_.colorSpace,_.isVideoTexture);Nt(q,_);let it;const It=_.mipmaps,P=_.isVideoTexture!==!0,ct=St.__version===void 0||j===!0,J=G.dataReady,pt=L(_,$);if(_.isDepthTexture)Rt=E(_.format===yi,_.type),ct&&(P?e.texStorage2D(i.TEXTURE_2D,1,Rt,$.width,$.height):e.texImage2D(i.TEXTURE_2D,0,Rt,$.width,$.height,0,dt,Ct,null));else if(_.isDataTexture)if(It.length>0){P&&ct&&e.texStorage2D(i.TEXTURE_2D,pt,Rt,It[0].width,It[0].height);for(let Q=0,K=It.length;Q<K;Q++)it=It[Q],P?J&&e.texSubImage2D(i.TEXTURE_2D,Q,0,0,it.width,it.height,dt,Ct,it.data):e.texImage2D(i.TEXTURE_2D,Q,Rt,it.width,it.height,0,dt,Ct,it.data);_.generateMipmaps=!1}else P?(ct&&e.texStorage2D(i.TEXTURE_2D,pt,Rt,$.width,$.height),J&&et(_,$,dt,Ct)):e.texImage2D(i.TEXTURE_2D,0,Rt,$.width,$.height,0,dt,Ct,$.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){P&&ct&&e.texStorage3D(i.TEXTURE_2D_ARRAY,pt,Rt,It[0].width,It[0].height,$.depth);for(let Q=0,K=It.length;Q<K;Q++)if(it=It[Q],_.format!==ke)if(dt!==null)if(P){if(J)if(_.layerUpdates.size>0){const mt=Ha(it.width,it.height,_.format,_.type);for(const Ot of _.layerUpdates){const ne=it.data.subarray(Ot*mt/it.data.BYTES_PER_ELEMENT,(Ot+1)*mt/it.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,Ot,it.width,it.height,1,dt,ne)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,it.width,it.height,$.depth,dt,it.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Q,Rt,it.width,it.height,$.depth,0,it.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else P?J&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,it.width,it.height,$.depth,dt,Ct,it.data):e.texImage3D(i.TEXTURE_2D_ARRAY,Q,Rt,it.width,it.height,$.depth,0,dt,Ct,it.data)}else{P&&ct&&e.texStorage2D(i.TEXTURE_2D,pt,Rt,It[0].width,It[0].height);for(let Q=0,K=It.length;Q<K;Q++)it=It[Q],_.format!==ke?dt!==null?P?J&&e.compressedTexSubImage2D(i.TEXTURE_2D,Q,0,0,it.width,it.height,dt,it.data):e.compressedTexImage2D(i.TEXTURE_2D,Q,Rt,it.width,it.height,0,it.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?J&&e.texSubImage2D(i.TEXTURE_2D,Q,0,0,it.width,it.height,dt,Ct,it.data):e.texImage2D(i.TEXTURE_2D,Q,Rt,it.width,it.height,0,dt,Ct,it.data)}else if(_.isDataArrayTexture)if(P){if(ct&&e.texStorage3D(i.TEXTURE_2D_ARRAY,pt,Rt,$.width,$.height,$.depth),J)if(_.layerUpdates.size>0){const Q=Ha($.width,$.height,_.format,_.type);for(const K of _.layerUpdates){const mt=$.data.subarray(K*Q/$.data.BYTES_PER_ELEMENT,(K+1)*Q/$.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,K,$.width,$.height,1,dt,Ct,mt)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,dt,Ct,$.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Rt,$.width,$.height,$.depth,0,dt,Ct,$.data);else if(_.isData3DTexture)P?(ct&&e.texStorage3D(i.TEXTURE_3D,pt,Rt,$.width,$.height,$.depth),J&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,dt,Ct,$.data)):e.texImage3D(i.TEXTURE_3D,0,Rt,$.width,$.height,$.depth,0,dt,Ct,$.data);else if(_.isFramebufferTexture){if(ct)if(P)e.texStorage2D(i.TEXTURE_2D,pt,Rt,$.width,$.height);else{let Q=$.width,K=$.height;for(let mt=0;mt<pt;mt++)e.texImage2D(i.TEXTURE_2D,mt,Rt,Q,K,0,dt,Ct,null),Q>>=1,K>>=1}}else if(It.length>0){if(P&&ct){const Q=he(It[0]);e.texStorage2D(i.TEXTURE_2D,pt,Rt,Q.width,Q.height)}for(let Q=0,K=It.length;Q<K;Q++)it=It[Q],P?J&&e.texSubImage2D(i.TEXTURE_2D,Q,0,0,dt,Ct,it):e.texImage2D(i.TEXTURE_2D,Q,Rt,dt,Ct,it);_.generateMipmaps=!1}else if(P){if(ct){const Q=he($);e.texStorage2D(i.TEXTURE_2D,pt,Rt,Q.width,Q.height)}J&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,dt,Ct,$)}else e.texImage2D(i.TEXTURE_2D,0,Rt,dt,Ct,$);p(_)&&h(q),St.__version=G.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function lt(y,_,F){if(_.image.length!==6)return;const q=Kt(y,_),j=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+F);const G=n.get(j);if(j.version!==G.__version||q===!0){e.activeTexture(i.TEXTURE0+F);const St=Yt.getPrimaries(Yt.workingColorSpace),ot=_.colorSpace===mn?null:Yt.getPrimaries(_.colorSpace),xt=_.colorSpace===mn||St===ot?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,xt);const Et=_.isCompressedTexture||_.image[0].isCompressedTexture,$=_.image[0]&&_.image[0].isDataTexture,dt=[];for(let K=0;K<6;K++)!Et&&!$?dt[K]=M(_.image[K],!0,s.maxCubemapSize):dt[K]=$?_.image[K].image:_.image[K],dt[K]=zt(_,dt[K]);const Ct=dt[0],Rt=r.convert(_.format,_.colorSpace),it=r.convert(_.type),It=T(_.internalFormat,Rt,it,_.colorSpace),P=_.isVideoTexture!==!0,ct=G.__version===void 0||q===!0,J=j.dataReady;let pt=L(_,Ct);Nt(i.TEXTURE_CUBE_MAP,_);let Q;if(Et){P&&ct&&e.texStorage2D(i.TEXTURE_CUBE_MAP,pt,It,Ct.width,Ct.height);for(let K=0;K<6;K++){Q=dt[K].mipmaps;for(let mt=0;mt<Q.length;mt++){const Ot=Q[mt];_.format!==ke?Rt!==null?P?J&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,mt,0,0,Ot.width,Ot.height,Rt,Ot.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,mt,It,Ot.width,Ot.height,0,Ot.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?J&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,mt,0,0,Ot.width,Ot.height,Rt,it,Ot.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,mt,It,Ot.width,Ot.height,0,Rt,it,Ot.data)}}}else{if(Q=_.mipmaps,P&&ct){Q.length>0&&pt++;const K=he(dt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,pt,It,K.width,K.height)}for(let K=0;K<6;K++)if($){P?J&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,dt[K].width,dt[K].height,Rt,it,dt[K].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,It,dt[K].width,dt[K].height,0,Rt,it,dt[K].data);for(let mt=0;mt<Q.length;mt++){const ne=Q[mt].image[K].image;P?J&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,mt+1,0,0,ne.width,ne.height,Rt,it,ne.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,mt+1,It,ne.width,ne.height,0,Rt,it,ne.data)}}else{P?J&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Rt,it,dt[K]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,It,Rt,it,dt[K]);for(let mt=0;mt<Q.length;mt++){const Ot=Q[mt];P?J&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,mt+1,0,0,Rt,it,Ot.image[K]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,mt+1,It,Rt,it,Ot.image[K])}}}p(_)&&h(i.TEXTURE_CUBE_MAP),G.__version=j.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function Mt(y,_,F,q,j,G){const St=r.convert(F.format,F.colorSpace),ot=r.convert(F.type),xt=T(F.internalFormat,St,ot,F.colorSpace),Et=n.get(_),$=n.get(F);if($.__renderTarget=_,!Et.__hasExternalTextures){const dt=Math.max(1,_.width>>G),Ct=Math.max(1,_.height>>G);j===i.TEXTURE_3D||j===i.TEXTURE_2D_ARRAY?e.texImage3D(j,G,xt,dt,Ct,_.depth,0,St,ot,null):e.texImage2D(j,G,xt,dt,Ct,0,St,ot,null)}e.bindFramebuffer(i.FRAMEBUFFER,y),Xt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,q,j,$.__webglTexture,0,gt(_)):(j===i.TEXTURE_2D||j>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,q,j,$.__webglTexture,G),e.bindFramebuffer(i.FRAMEBUFFER,null)}function nt(y,_,F){if(i.bindRenderbuffer(i.RENDERBUFFER,y),_.depthBuffer){const q=_.depthTexture,j=q&&q.isDepthTexture?q.type:null,G=E(_.stencilBuffer,j),St=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ot=gt(_);Xt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ot,G,_.width,_.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,ot,G,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,G,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,St,i.RENDERBUFFER,y)}else{const q=_.textures;for(let j=0;j<q.length;j++){const G=q[j],St=r.convert(G.format,G.colorSpace),ot=r.convert(G.type),xt=T(G.internalFormat,St,ot,G.colorSpace),Et=gt(_);F&&Xt(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Et,xt,_.width,_.height):Xt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Et,xt,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,xt,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function at(y,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,y),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const q=n.get(_.depthTexture);q.__renderTarget=_,(!q.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),Y(_.depthTexture,0);const j=q.__webglTexture,G=gt(_);if(_.depthTexture.format===Ei)Xt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,j,0,G):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,j,0);else if(_.depthTexture.format===yi)Xt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,j,0,G):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,j,0);else throw new Error("Unknown depthTexture format")}function Pt(y){const _=n.get(y),F=y.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==y.depthTexture){const q=y.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),q){const j=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,q.removeEventListener("dispose",j)};q.addEventListener("dispose",j),_.__depthDisposeCallback=j}_.__boundDepthTexture=q}if(y.depthTexture&&!_.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");const q=y.texture.mipmaps;q&&q.length>0?at(_.__webglFramebuffer[0],y):at(_.__webglFramebuffer,y)}else if(F){_.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[q]),_.__webglDepthbuffer[q]===void 0)_.__webglDepthbuffer[q]=i.createRenderbuffer(),nt(_.__webglDepthbuffer[q],y,!1);else{const j=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,G=_.__webglDepthbuffer[q];i.bindRenderbuffer(i.RENDERBUFFER,G),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,G)}}else{const q=y.texture.mipmaps;if(q&&q.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),nt(_.__webglDepthbuffer,y,!1);else{const j=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,G=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,G),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,G)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Ft(y,_,F){const q=n.get(y);_!==void 0&&Mt(q.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&Pt(y)}function Lt(y){const _=y.texture,F=n.get(y),q=n.get(_);y.addEventListener("dispose",w);const j=y.textures,G=y.isWebGLCubeRenderTarget===!0,St=j.length>1;if(St||(q.__webglTexture===void 0&&(q.__webglTexture=i.createTexture()),q.__version=_.version,a.memory.textures++),G){F.__webglFramebuffer=[];for(let ot=0;ot<6;ot++)if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer[ot]=[];for(let xt=0;xt<_.mipmaps.length;xt++)F.__webglFramebuffer[ot][xt]=i.createFramebuffer()}else F.__webglFramebuffer[ot]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer=[];for(let ot=0;ot<_.mipmaps.length;ot++)F.__webglFramebuffer[ot]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(St)for(let ot=0,xt=j.length;ot<xt;ot++){const Et=n.get(j[ot]);Et.__webglTexture===void 0&&(Et.__webglTexture=i.createTexture(),a.memory.textures++)}if(y.samples>0&&Xt(y)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let ot=0;ot<j.length;ot++){const xt=j[ot];F.__webglColorRenderbuffer[ot]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[ot]);const Et=r.convert(xt.format,xt.colorSpace),$=r.convert(xt.type),dt=T(xt.internalFormat,Et,$,xt.colorSpace,y.isXRRenderTarget===!0),Ct=gt(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ct,dt,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ot,i.RENDERBUFFER,F.__webglColorRenderbuffer[ot])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),nt(F.__webglDepthRenderbuffer,y,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(G){e.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),Nt(i.TEXTURE_CUBE_MAP,_);for(let ot=0;ot<6;ot++)if(_.mipmaps&&_.mipmaps.length>0)for(let xt=0;xt<_.mipmaps.length;xt++)Mt(F.__webglFramebuffer[ot][xt],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,xt);else Mt(F.__webglFramebuffer[ot],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0);p(_)&&h(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(St){for(let ot=0,xt=j.length;ot<xt;ot++){const Et=j[ot],$=n.get(Et);e.bindTexture(i.TEXTURE_2D,$.__webglTexture),Nt(i.TEXTURE_2D,Et),Mt(F.__webglFramebuffer,y,Et,i.COLOR_ATTACHMENT0+ot,i.TEXTURE_2D,0),p(Et)&&h(i.TEXTURE_2D)}e.unbindTexture()}else{let ot=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(ot=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ot,q.__webglTexture),Nt(ot,_),_.mipmaps&&_.mipmaps.length>0)for(let xt=0;xt<_.mipmaps.length;xt++)Mt(F.__webglFramebuffer[xt],y,_,i.COLOR_ATTACHMENT0,ot,xt);else Mt(F.__webglFramebuffer,y,_,i.COLOR_ATTACHMENT0,ot,0);p(_)&&h(ot),e.unbindTexture()}y.depthBuffer&&Pt(y)}function A(y){const _=y.textures;for(let F=0,q=_.length;F<q;F++){const j=_[F];if(p(j)){const G=b(y),St=n.get(j).__webglTexture;e.bindTexture(G,St),h(G),e.unbindTexture()}}}const se=[],Gt=[];function jt(y){if(y.samples>0){if(Xt(y)===!1){const _=y.textures,F=y.width,q=y.height;let j=i.COLOR_BUFFER_BIT;const G=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,St=n.get(y),ot=_.length>1;if(ot)for(let Et=0;Et<_.length;Et++)e.bindFramebuffer(i.FRAMEBUFFER,St.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Et,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,St.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Et,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,St.__webglMultisampledFramebuffer);const xt=y.texture.mipmaps;xt&&xt.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,St.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,St.__webglFramebuffer);for(let Et=0;Et<_.length;Et++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(j|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(j|=i.STENCIL_BUFFER_BIT)),ot){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,St.__webglColorRenderbuffer[Et]);const $=n.get(_[Et]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,$,0)}i.blitFramebuffer(0,0,F,q,0,0,F,q,j,i.NEAREST),l===!0&&(se.length=0,Gt.length=0,se.push(i.COLOR_ATTACHMENT0+Et),y.depthBuffer&&y.resolveDepthBuffer===!1&&(se.push(G),Gt.push(G),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Gt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,se))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ot)for(let Et=0;Et<_.length;Et++){e.bindFramebuffer(i.FRAMEBUFFER,St.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Et,i.RENDERBUFFER,St.__webglColorRenderbuffer[Et]);const $=n.get(_[Et]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,St.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Et,i.TEXTURE_2D,$,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,St.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&l){const _=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function gt(y){return Math.min(s.maxSamples,y.samples)}function Xt(y){const _=n.get(y);return y.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function bt(y){const _=a.render.frame;d.get(y)!==_&&(d.set(y,_),y.update())}function zt(y,_){const F=y.colorSpace,q=y.format,j=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||F!==oi&&F!==mn&&(Yt.getTransfer(F)===Jt?(q!==ke||j!==Ke)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),_}function he(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(c.width=y.naturalWidth||y.width,c.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(c.width=y.displayWidth,c.height=y.displayHeight):(c.width=y.width,c.height=y.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=H,this.setTexture2D=Y,this.setTexture2DArray=k,this.setTexture3D=Z,this.setTextureCube=V,this.rebindTextures=Ft,this.setupRenderTarget=Lt,this.updateRenderTargetMipmap=A,this.updateMultisampleRenderTarget=jt,this.setupDepthRenderbuffer=Pt,this.setupFrameBufferTexture=Mt,this.useMultisampledRTT=Xt}function ap(i,t){function e(n,s=mn){let r;const a=Yt.getTransfer(s);if(n===Ke)return i.UNSIGNED_BYTE;if(n===kr)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Wr)return i.UNSIGNED_SHORT_5_5_5_1;if(n===So)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===xo)return i.BYTE;if(n===Mo)return i.SHORT;if(n===Mi)return i.UNSIGNED_SHORT;if(n===Gr)return i.INT;if(n===Un)return i.UNSIGNED_INT;if(n===rn)return i.FLOAT;if(n===Ti)return i.HALF_FLOAT;if(n===Eo)return i.ALPHA;if(n===yo)return i.RGB;if(n===ke)return i.RGBA;if(n===Ei)return i.DEPTH_COMPONENT;if(n===yi)return i.DEPTH_STENCIL;if(n===To)return i.RED;if(n===Xr)return i.RED_INTEGER;if(n===bo)return i.RG;if(n===qr)return i.RG_INTEGER;if(n===Yr)return i.RGBA_INTEGER;if(n===es||n===ns||n===is||n===ss)if(a===Jt)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===es)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ns)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===is)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ss)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===es)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ns)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===is)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ss)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ur||n===dr||n===fr||n===pr)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ur)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===dr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===fr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===pr)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===mr||n===_r||n===gr)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===mr||n===_r)return a===Jt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===gr)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===vr||n===xr||n===Mr||n===Sr||n===Er||n===yr||n===Tr||n===br||n===Ar||n===wr||n===Rr||n===Cr||n===Pr||n===Dr)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===vr)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===xr)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Mr)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Sr)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Er)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===yr)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Tr)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===br)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ar)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===wr)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Rr)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Cr)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Pr)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Dr)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===rs||n===Lr||n===Ur)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===rs)return a===Jt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Lr)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ur)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ao||n===Ir||n===Nr||n===Fr)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===rs)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ir)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Nr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Fr)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Si?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const op=`
void main() {
...
}`;class cp{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const s=new Ee,r=t.properties.get(s);r.__webglTexture=e.texture,(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new xn({vertexShader:op,fragmentShader:lp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Se(new ms(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class hp extends Fn{constructor(t,e){super();const n=this;let s=null,r=1,a=null,o="local-floor",l=1,c=null,d=null,u=null,f=null,m=null,v=null;const M=new cp,p=e.getContextAttributes();let h=null,b=null;const T=[],E=[],L=new wt;let R=null;const w=new Le;w.viewport=new te;const D=new Le;D.viewport=new te;const S=[w,D],x=new Cc;let C=null,H=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(W){let et=T[W];return et===void 0&&(et=new Vs,T[W]=et),et.getTargetRaySpace()},this.getControllerGrip=function(W){let et=T[W];return et===void 0&&(et=new Vs,T[W]=et),et.getGripSpace()},this.getHand=function(W){let et=T[W];return et===void 0&&(et=new Vs,T[W]=et),et.getHandSpace()};function O(W){const et=E.indexOf(W.inputSource);if(et===-1)return;const vt=T[et];vt!==void 0&&(vt.update(W.inputSource,W.frame,c||a),vt.dispatchEvent({type:W.type,data:W.inputSource}))}function X(){s.removeEventListener("select",O),s.removeEventListener("selectstart",O),s.removeEventListener("selectend",O),s.removeEventListener("squeeze",O),s.removeEventListener("squeezestart",O),s.removeEventListener("squeezeend",O),s.removeEventListener("end",X),s.removeEventListener("inputsourceschange",Y);for(let W=0;W<T.length;W++){const et=E[W];et!==null&&(E[W]=null,T[W].disconnect(et))}C=null,H=null,M.reset(),t.setRenderTarget(h),m=null,f=null,u=null,s=null,b=null,Kt.stop(),n.isPresenting=!1,t.setPixelRatio(R),t.setSize(L.width,L.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(W){r=W,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(W){o=W,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(W){c=W},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return u},this.getFrame=function(){return v},this.getSession=function(){return s},this.setSession=async function(W){if(s=W,s!==null){if(h=t.getRenderTarget(),s.addEventListener("select",O),s.addEventListener("selectstart",O),s.addEventListener("selectend",O),s.addEventListener("squeeze",O),s.addEventListener("squeezestart",O),s.addEventListener("squeezeend",O),s.addEventListener("end",X),s.addEventListener("inputsourceschange",Y),p.xrCompatible!==!0&&await e.makeXRCompatible(),R=t.getPixelRatio(),t.getSize(L),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let vt=null,lt=null,Mt=null;p.depth&&(Mt=p.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,vt=p.stencil?yi:Ei,lt=p.stencil?Si:Un);const nt={colorFormat:e.RGBA8,depthFormat:Mt,scaleFactor:r};u=new XRWebGLBinding(s,e),f=u.createProjectionLayer(nt),s.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),b=new Nn(f.textureWidth,f.textureHeight,{format:ke,type:Ke,depthTexture:new Ho(f.textureWidth,f.textureHeight,lt,void 0,void 0,void 0,void 0,void 0,void 0,vt),stencilBuffer:p.stencil,colorSpace:t.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const vt={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:r};m=new XRWebGLLayer(s,e,vt),s.updateRenderState({baseLayer:m}),t.setPixelRatio(1),t.setSize(m.framebufferWidth,m.framebufferHeight,!1),b=new Nn(m.framebufferWidth,m.framebufferHeight,{format:ke,type:Ke,colorSpace:t.outputColorSpace,stencilBuffer:p.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),Kt.setContext(s),Kt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function Y(W){for(let et=0;et<W.removed.length;et++){const vt=W.removed[et],lt=E.indexOf(vt);lt>=0&&(E[lt]=null,T[lt].disconnect(vt))}for(let et=0;et<W.added.length;et++){const vt=W.added[et];let lt=E.indexOf(vt);if(lt===-1){for(let nt=0;nt<T.length;nt++)if(nt>=E.length){E.push(vt),lt=nt;break}else if(E[nt]===null){E[nt]=vt,lt=nt;break}if(lt===-1)break}const Mt=T[lt];Mt&&Mt.connect(vt)}}const k=new U,Z=new U;function V(W,et,vt){k.setFromMatrixPosition(et.matrixWorld),Z.setFromMatrixPosition(vt.matrixWorld);const lt=k.distanceTo(Z),Mt=et.projectionMatrix.elements,nt=vt.projectionMatrix.elements,at=Mt[14]/(Mt[10]-1),Pt=Mt[14]/(Mt[10]+1),Ft=(Mt[9]+1)/Mt[5],Lt=(Mt[9]-1)/Mt[5],A=(Mt[8]-1)/Mt[0],se=(nt[8]+1)/nt[0],Gt=at*A,jt=at*se,gt=lt/(-A+se),Xt=gt*-A;if(et.matrixWorld.decompose(W.position,W.quaternion,W.scale),W.translateX(Xt),W.translateZ(gt),W.matrixWorld.compose(W.position,W.quaternion,W.scale),W.matrixWorldInverse.copy(W.matrixWorld).invert(),Mt[10]===-1)W.projectionMatrix.copy(et.projectionMatrix),W.projectionMatrixInverse.copy(et.projectionMatrixInverse);else{const bt=at+gt,zt=Pt+gt,he=Gt-Xt,y=jt+(lt-Xt),_=Ft*Pt/zt*bt,F=Lt*Pt/zt*bt;W.projectionMatrix.makePerspective(he,y,_,F,bt,zt),W.projectionMatrixInverse.copy(W.projectionMatrix).invert()}}function rt(W,et){et===null?W.matrixWorld.copy(W.matrix):W.matrixWorld.multiplyMatrices(et.matrixWorld,W.matrix),W.matrixWorldInverse.copy(W.matrixWorld).invert()}this.updateCamera=function(W){if(s===null)return;let et=W.near,vt=W.far;M.texture!==null&&(M.depthNear>0&&(et=M.depthNear),M.depthFar>0&&(vt=M.depthFar)),x.near=D.near=w.near=et,x.far=D.far=w.far=vt,(C!==x.near||H!==x.far)&&(s.updateRenderState({depthNear:x.near,depthFar:x.far}),C=x.near,H=x.far),w.layers.mask=W.layers.mask|2,D.layers.mask=W.layers.mask|4,x.layers.mask=w.layers.mask|D.layers.mask;const lt=W.parent,Mt=x.cameras;rt(x,lt);for(let nt=0;nt<Mt.length;nt++)rt(Mt[nt],lt);Mt.length===2?V(x,w,D):x.projectionMatrix.copy(w.projectionMatrix),ut(W,x,lt)};function ut(W,et,vt){vt===null?W.matrix.copy(et.matrixWorld):(W.matrix.copy(vt.matrixWorld),W.matrix.invert(),W.matrix.multiply(et.matrixWorld)),W.matrix.decompose(W.position,W.quaternion,W.scale),W.updateMatrixWorld(!0),W.projectionMatrix.copy(et.projectionMatrix),W.projectionMatrixInverse.copy(et.projectionMatrixInverse),W.isPerspectiveCamera&&(W.fov=Or*2*Math.atan(1/W.projectionMatrix.elements[5]),W.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(f===null&&m===null))return l},this.setFoveation=function(W){l=W,f!==null&&(f.fixedFoveation=W),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=W)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(x)};let yt=null;function Nt(W,et){if(d=et.getViewerPose(c||a),v=et,d!==null){const vt=d.views;m!==null&&(t.setRenderTargetFramebuffer(b,m.framebuffer),t.setRenderTarget(b));let lt=!1;vt.length!==x.cameras.length&&(x.cameras.length=0,lt=!0);for(let at=0;at<vt.length;at++){const Pt=vt[at];let Ft=null;if(m!==null)Ft=m.getViewport(Pt);else{const A=u.getViewSubImage(f,Pt);Ft=A.viewport,at===0&&(t.setRenderTargetTextures(b,A.colorTexture,A.depthStencilTexture),t.setRenderTarget(b))}let Lt=S[at];Lt===void 0&&(Lt=new Le,Lt.layers.enable(at),Lt.viewport=new te,S[at]=Lt),Lt.matrix.fromArray(Pt.transform.matrix),Lt.matrix.decompose(Lt.position,Lt.quaternion,Lt.scale),Lt.projectionMatrix.fromArray(Pt.projectionMatrix),Lt.projectionMatrixInverse.copy(Lt.projectionMatrix).invert(),Lt.viewport.set(Ft.x,Ft.y,Ft.width,Ft.height),at===0&&(x.matrix.copy(Lt.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),lt===!0&&x.cameras.push(Lt)}const Mt=s.enabledFeatures;if(Mt&&Mt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&u){const at=u.getDepthInformation(vt[0]);at&&at.isValid&&at.texture&&M.init(t,at,s.renderState)}}for(let vt=0;vt<T.length;vt++){const lt=E[vt],Mt=T[vt];lt!==null&&Mt!==void 0&&Mt.update(lt,et,c||a)}yt&&yt(W,et),et.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:et}),v=null}const Kt=new ko;Kt.setAnimationLoop(Nt),this.setAnimationLoop=function(W){yt=W},this.dispose=function(){}}}const wn=new je,up=new ae;function dp(i,t){function e(p,h){p.matrixAutoUpdate===!0&&p.updateMatrix(),h.value.copy(p.matrix)}function n(p,h){h.color.getRGB(p.fogColor.value,Fo(i)),h.isFog?(p.fogNear.value=h.near,p.fogFar.value=h.far):h.isFogExp2&&(p.fogDensity.value=h.density)}function s(p,h,b,T,E){h.isMeshBasicMaterial||h.isMeshLambertMaterial?r(p,h):h.isMeshToonMaterial?(r(p,h),u(p,h)):h.isMeshPhongMaterial?(r(p,h),d(p,h)):h.isMeshStandardMaterial?(r(p,h),f(p,h),h.isMeshPhysicalMaterial&&m(p,h,E)):h.isMeshMatcapMaterial?(r(p,h),v(p,h)):h.isMeshDepthMaterial?r(p,h):h.isMeshDistanceMaterial?(r(p,h),M(p,h)):h.isMeshNormalMaterial?r(p,h):h.isLineBasicMaterial?(a(p,h),h.isLineDashedMaterial&&o(p,h)):h.isPointsMaterial?l(p,h,b,T):h.isSpriteMaterial?c(p,h):h.isShadowMaterial?(p.color.value.copy(h.color),p.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function r(p,h){p.opacity.value=h.opacity,h.color&&p.diffuse.value.copy(h.color),h.emissive&&p.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(p.map.value=h.map,e(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,e(h.alphaMap,p.alphaMapTransform)),h.bumpMap&&(p.bumpMap.value=h.bumpMap,e(h.bumpMap,p.bumpMapTransform),p.bumpScale.value=h.bumpScale,h.side===we&&(p.bumpScale.value*=-1)),h.normalMap&&(p.normalMap.value=h.normalMap,e(h.normalMap,p.normalMapTransform),p.normalScale.value.copy(h.normalScale),h.side===we&&p.normalScale.value.negate()),h.displacementMap&&(p.displacementMap.value=h.displacementMap,e(h.displacementMap,p.displacementMapTransform),p.displacementScale.value=h.displacementScale,p.displacementBias.value=h.displacementBias),h.emissiveMap&&(p.emissiveMap.value=h.emissiveMap,e(h.emissiveMap,p.emissiveMapTransform)),h.specularMap&&(p.specularMap.value=h.specularMap,e(h.specularMap,p.specularMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest);const b=t.get(h),T=b.envMap,E=b.envMapRotation;T&&(p.envMap.value=T,wn.copy(E),wn.x*=-1,wn.y*=-1,wn.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(wn.y*=-1,wn.z*=-1),p.envMapRotation.value.setFromMatrix4(up.makeRotationFromEuler(wn)),p.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=h.reflectivity,p.ior.value=h.ior,p.refractionRatio.value=h.refractionRatio),h.lightMap&&(p.lightMap.value=h.lightMap,p.lightMapIntensity.value=h.lightMapIntensity,e(h.lightMap,p.lightMapTransform)),h.aoMap&&(p.aoMap.value=h.aoMap,p.aoMapIntensity.value=h.aoMapIntensity,e(h.aoMap,p.aoMapTransform))}function a(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,h.map&&(p.map.value=h.map,e(h.map,p.mapTransform))}function o(p,h){p.dashSize.value=h.dashSize,p.totalSize.value=h.dashSize+h.gapSize,p.scale.value=h.scale}function l(p,h,b,T){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.size.value=h.size*b,p.scale.value=T*.5,h.map&&(p.map.value=h.map,e(h.map,p.uvTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,e(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function c(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.rotation.value=h.rotation,h.map&&(p.map.value=h.map,e(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,e(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function d(p,h){p.specular.value.copy(h.specular),p.shininess.value=Math.max(h.shininess,1e-4)}function u(p,h){h.gradientMap&&(p.gradientMap.value=h.gradientMap)}function f(p,h){p.metalness.value=h.metalness,h.metalnessMap&&(p.metalnessMap.value=h.metalnessMap,e(h.metalnessMap,p.metalnessMapTransform)),p.roughness.value=h.roughness,h.roughnessMap&&(p.roughnessMap.value=h.roughnessMap,e(h.roughnessMap,p.roughnessMapTransform)),h.envMap&&(p.envMapIntensity.value=h.envMapIntensity)}function m(p,h,b){p.ior.value=h.ior,h.sheen>0&&(p.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),p.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(p.sheenColorMap.value=h.sheenColorMap,e(h.sheenColorMap,p.sheenColorMapTransform)),h.sheenRoughnessMap&&(p.sheenRoughnessMap.value=h.sheenRoughnessMap,e(h.sheenRoughnessMap,p.sheenRoughnessMapTransform))),h.clearcoat>0&&(p.clearcoat.value=h.clearcoat,p.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(p.clearcoatMap.value=h.clearcoatMap,e(h.clearcoatMap,p.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,e(h.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(p.clearcoatNormalMap.value=h.clearcoatNormalMap,e(h.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===we&&p.clearcoatNormalScale.value.negate())),h.dispersion>0&&(p.dispersion.value=h.dispersion),h.iridescence>0&&(p.iridescence.value=h.iridescence,p.iridescenceIOR.value=h.iridescenceIOR,p.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(p.iridescenceMap.value=h.iridescenceMap,e(h.iridescenceMap,p.iridescenceMapTransform)),h.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=h.iridescenceThicknessMap,e(h.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),h.transmission>0&&(p.transmission.value=h.transmission,p.transmissionSamplerMap.value=b.texture,p.transmissionSamplerSize.value.set(b.width,b.height),h.transmissionMap&&(p.transmissionMap.value=h.transmissionMap,e(h.transmissionMap,p.transmissionMapTransform)),p.thickness.value=h.thickness,h.thicknessMap&&(p.thicknessMap.value=h.thicknessMap,e(h.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=h.attenuationDistance,p.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(p.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(p.anisotropyMap.value=h.anisotropyMap,e(h.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=h.specularIntensity,p.specularColor.value.copy(h.specularColor),h.specularColorMap&&(p.specularColorMap.value=h.specularColorMap,e(h.specularColorMap,p.specularColorMapTransform)),h.specularIntensityMap&&(p.specularIntensityMap.value=h.specularIntensityMap,e(h.specularIntensityMap,p.specularIntensityMapTransform))}function v(p,h){h.matcap&&(p.matcap.value=h.matcap)}function M(p,h){const b=t.get(h).light;p.referencePosition.value.setFromMatrixPosition(b.matrixWorld),p.nearDistance.value=b.shadow.camera.near,p.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function fp(i,t,e,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(b,T){const E=T.program;n.uniformBlockBinding(b,E)}function c(b,T){let E=s[b.id];E===void 0&&(v(b),E=d(b),s[b.id]=E,b.addEventListener("dispose",p));const L=T.program;n.updateUBOMapping(b,L);const R=t.render.frame;r[b.id]!==R&&(f(b),r[b.id]=R)}function d(b){const T=u();b.__bindingPointIndex=T;const E=i.createBuffer(),L=b.__size,R=b.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,L,R),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,E),E}function u(){for(let b=0;b<o;b++)if(a.indexOf(b)===-1)return a.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(b){const T=s[b.id],E=b.uniforms,L=b.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let R=0,w=E.length;R<w;R++){const D=Array.isArray(E[R])?E[R]:[E[R]];for(let S=0,x=D.length;S<x;S++){const C=D[S];if(m(C,R,S,L)===!0){const H=C.__offset,O=Array.isArray(C.value)?C.value:[C.value];let X=0;for(let Y=0;Y<O.length;Y++){const k=O[Y],Z=M(k);typeof k=="number"||typeof k=="boolean"?(C.__data[0]=k,i.bufferSubData(i.UNIFORM_BUFFER,H+X,C.__data)):k.isMatrix3?(C.__data[0]=k.elements[0],C.__data[1]=k.elements[1],C.__data[2]=k.elements[2],C.__data[3]=0,C.__data[4]=k.elements[3],C.__data[5]=k.elements[4],C.__data[6]=k.elements[5],C.__data[7]=0,C.__data[8]=k.elements[6],C.__data[9]=k.elements[7],C.__data[10]=k.elements[8],C.__data[11]=0):(k.toArray(C.__data,X),X+=Z.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,H,C.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(b,T,E,L){const R=b.value,w=T+"_"+E;if(L[w]===void 0)return typeof R=="number"||typeof R=="boolean"?L[w]=R:L[w]=R.clone(),!0;{const D=L[w];if(typeof R=="number"||typeof R=="boolean"){if(D!==R)return L[w]=R,!0}else if(D.equals(R)===!1)return D.copy(R),!0}return!1}function v(b){const T=b.uniforms;let E=0;const L=16;for(let w=0,D=T.length;w<D;w++){const S=Array.isArray(T[w])?T[w]:[T[w]];for(let x=0,C=S.length;x<C;x++){const H=S[x],O=Array.isArray(H.value)?H.value:[H.value];for(let X=0,Y=O.length;X<Y;X++){const k=O[X],Z=M(k),V=E%L,rt=V%Z.boundary,ut=V+rt;E+=rt,ut!==0&&L-ut<Z.storage&&(E+=L-ut),H.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),H.__offset=E,E+=Z.storage}}}const R=E%L;return R>0&&(E+=L-R),b.__size=E,b.__cache={},this}function M(b){const T={boundary:0,storage:0};return typeof b=="number"||typeof b=="boolean"?(T.boundary=4,T.storage=4):b.isVector2?(T.boundary=8,T.storage=8):b.isVector3||b.isColor?(T.boundary=16,T.storage=12):b.isVector4?(T.boundary=16,T.storage=16):b.isMatrix3?(T.boundary=48,T.storage=48):b.isMatrix4?(T.boundary=64,T.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),T}function p(b){const T=b.target;T.removeEventListener("dispose",p);const E=a.indexOf(T.__bindingPointIndex);a.splice(E,1),i.deleteBuffer(s[T.id]),delete s[T.id],delete r[T.id]}function h(){for(const b in s)i.deleteBuffer(s[b]);a=[],s={},r={}}return{bind:l,update:c,dispose:h}}class pp{constructor(t={}){const{canvas:e=kl(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:u=!1,reverseDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=a;const v=new Uint32Array(4),M=new Int32Array(4);let p=null,h=null;const b=[],T=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=gn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const E=this;let L=!1;this._outputColorSpace=Ae;let R=0,w=0,D=null,S=-1,x=null;const C=new te,H=new te;let O=null;const X=new kt(0);let Y=0,k=e.width,Z=e.height,V=1,rt=null,ut=null;const yt=new te(0,0,k,Z),Nt=new te(0,0,k,Z);let Kt=!1;const W=new $r;let et=!1,vt=!1;const lt=new ae,Mt=new ae,nt=new U,at=new te,Pt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ft=!1;function Lt(){return D===null?V:1}let A=n;function se(g,I){return e.getContext(g,I)}try{const g={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Vr}`),e.addEventListener("webglcontextlost",pt,!1),e.addEventListener("webglcontextrestored",Q,!1),e.addEventListener("webglcontextcreationerror",K,!1),A===null){const I="webgl2";if(A=se(I,g),A===null)throw se(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(g){throw console.error("THREE.WebGLRenderer: "+g.message),g}let Gt,jt,gt,Xt,bt,zt,he,y,_,F,q,j,G,St,ot,xt,Et,$,dt,Ct,Rt,it,It,P;function ct(){Gt=new yd(A),Gt.init(),it=new ap(A,Gt),jt=new _d(A,Gt,t,it),gt=new sp(A,Gt),jt.reverseDepthBuffer&&f&&gt.buffers.depth.setReversed(!0),Xt=new Ad(A),bt=new Xf,zt=new rp(A,Gt,gt,bt,jt,it,Xt),he=new vd(E),y=new Ed(E),_=new Lc(A),It=new pd(A,_),F=new Td(A,_,Xt,It),q=new Rd(A,F,_,Xt),dt=new wd(A,jt,zt),xt=new gd(bt),j=new Wf(E,he,y,Gt,jt,It,xt),G=new dp(E,bt),St=new Yf,ot=new Qf(Gt),$=new fd(E,he,y,gt,q,m,l),Et=new np(E,q,jt),P=new fp(A,Xt,jt,gt),Ct=new md(A,Gt,Xt),Rt=new bd(A,Gt,Xt),Xt.programs=j.programs,E.capabilities=jt,E.extensions=Gt,E.properties=bt,E.renderLists=St,E.shadowMap=Et,E.state=gt,E.info=Xt}ct();const J=new hp(E,A);this.xr=J,this.getContext=function(){return A},this.getContextAttributes=function(){return A.getContextAttributes()},this.forceContextLoss=function(){const g=Gt.get("WEBGL_lose_context");g&&g.loseContext()},this.forceContextRestore=function(){const g=Gt.get("WEBGL_lose_context");g&&g.restoreContext()},this.getPixelRatio=function(){return V},this.setPixelRatio=function(g){g!==void 0&&(V=g,this.setSize(k,Z,!1))},this.getSize=function(g){return g.set(k,Z)},this.setSize=function(g,I,B=!0){if(J.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}k=g,Z=I,e.width=Math.floor(g*V),e.height=Math.floor(I*V),B===!0&&(e.style.width=g+"px",e.style.height=I+"px"),this.setViewport(0,0,g,I)},this.getDrawingBufferSize=function(g){return g.set(k*V,Z*V).floor()},this.setDrawingBufferSize=function(g,I,B){k=g,Z=I,V=B,e.width=Math.floor(g*B),e.height=Math.floor(I*B),this.setViewport(0,0,g,I)},this.getCurrentViewport=function(g){return g.copy(C)},this.getViewport=function(g){return g.copy(yt)},this.setViewport=function(g,I,B,z){g.isVector4?yt.set(g.x,g.y,g.z,g.w):yt.set(g,I,B,z),gt.viewport(C.copy(yt).multiplyScalar(V).round())},this.getScissor=function(g){return g.copy(Nt)},this.setScissor=function(g,I,B,z){g.isVector4?Nt.set(g.x,g.y,g.z,g.w):Nt.set(g,I,B,z),gt.scissor(H.copy(Nt).multiplyScalar(V).round())},this.getScissorTest=function(){return Kt},this.setScissorTest=function(g){gt.setScissorTest(Kt=g)},this.setOpaqueSort=function(g){rt=g},this.setTransparentSort=function(g){ut=g},this.getClearColor=function(g){return g.copy($.getClearColor())},this.setClearColor=function(){$.setClearColor(...arguments)},this.getClearAlpha=function(){return $.getClearAlpha()},this.setClearAlpha=function(){$.setClearAlpha(...arguments)},this.clear=function(g=!0,I=!0,B=!0){let z=0;if(g){let N=!1;if(D!==null){const tt=D.texture.format;N=tt===Yr||tt===qr||tt===Xr}if(N){const tt=D.texture.type,ht=tt===Ke||tt===Un||tt===Mi||tt===Si||tt===kr||tt===Wr,_t=$.getClearColor(),ft=$.getClearAlpha(),Dt=_t.r,Ut=_t.g,Tt=_t.b;ht?(v[0]=Dt,v[1]=Ut,v[2]=Tt,v[3]=ft,A.clearBufferuiv(A.COLOR,0,v)):(M[0]=Dt,M[1]=Ut,M[2]=Tt,M[3]=ft,A.clearBufferiv(A.COLOR,0,M))}else z|=A.COLOR_BUFFER_BIT}I&&(z|=A.DEPTH_BUFFER_BIT),B&&(z|=A.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),A.clear(z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",pt,!1),e.removeEventListener("webglcontextrestored",Q,!1),e.removeEventListener("webglcontextcreationerror",K,!1),$.dispose(),St.dispose(),ot.dispose(),bt.dispose(),he.dispose(),y.dispose(),q.dispose(),It.dispose(),P.dispose(),j.dispose(),J.dispose(),J.removeEventListener("sessionstart",na),J.removeEventListener("sessionend",ia),Mn.stop()};function pt(g){g.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),L=!0}function Q(){console.log("THREE.WebGLRenderer: Context Restored."),L=!1;const g=Xt.autoReset,I=Et.enabled,B=Et.autoUpdate,z=Et.needsUpdate,N=Et.type;ct(),Xt.autoReset=g,Et.enabled=I,Et.autoUpdate=B,Et.needsUpdate=z,Et.type=N}function K(g){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",g.statusMessage)}function mt(g){const I=g.target;I.removeEventListener("dispose",mt),Ot(I)}function Ot(g){ne(g),bt.remove(g)}function ne(g){const I=bt.get(g).programs;I!==void 0&&(I.forEach(function(B){j.releaseProgram(B)}),g.isShaderMaterial&&j.releaseShaderCache(g))}this.renderBufferDirect=function(g,I,B,z,N,tt){I===null&&(I=Pt);const ht=N.isMesh&&N.matrixWorld.determinant()<0,_t=jo(g,I,B,z,N);gt.setMaterial(z,ht);let ft=B.index,Dt=1;if(z.wireframe===!0){if(ft=F.getWireframeAttribute(B),ft===void 0)return;Dt=2}const Ut=B.drawRange,Tt=B.attributes.position;let Wt=Ut.start*Dt,$t=(Ut.start+Ut.count)*Dt;tt!==null&&(Wt=Math.max(Wt,tt.start*Dt),$t=Math.min($t,(tt.start+tt.count)*Dt)),ft!==null?(Wt=Math.max(Wt,0),$t=Math.min($t,ft.count)):Tt!=null&&(Wt=Math.max(Wt,0),$t=Math.min($t,Tt.count));const le=$t-Wt;if(le<0||le===1/0)return;It.setup(N,z,_t,B,ft);let ie,ee=Ct;if(ft!==null&&(ie=_.get(ft),ee=Rt,ee.setIndex(ie)),N.isMesh)z.wireframe===!0?(gt.setLineWidth(z.wireframeLinewidth*Lt()),ee.setMode(A.LINES)):ee.setMode(A.TRIANGLES);else if(N.isLine){let At=z.linewidth;At===void 0&&(At=1),gt.setLineWidth(At*Lt()),N.isLineSegments?ee.setMode(A.LINES):N.isLineLoop?ee.setMode(A.LINE_LOOP):ee.setMode(A.LINE_STRIP)}else N.isPoints?ee.setMode(A.POINTS):N.isSprite&&ee.setMode(A.TRIANGLES);if(N.isBatchedMesh)if(N._multiDrawInstances!==null)ni("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ee.renderMultiDrawInstances(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount,N._multiDrawInstances);else if(Gt.get("WEBGL_multi_draw"))ee.renderMultiDraw(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount);else{const At=N._multiDrawStarts,oe=N._multiDrawCounts,qt=N._multiDrawCount,Re=ft?_.get(ft).bytesPerElement:1,On=bt.get(z).currentProgram.getUniforms();for(let Ce=0;Ce<qt;Ce++)On.setValue(A,"_gl_DrawID",Ce),ee.render(At[Ce]/Re,oe[Ce])}else if(N.isInstancedMesh)ee.renderInstances(Wt,le,N.count);else if(B.isInstancedBufferGeometry){const At=B._maxInstanceCount!==void 0?B._maxInstanceCount:1/0,oe=Math.min(B.instanceCount,At);ee.renderInstances(Wt,le,oe)}else ee.render(Wt,le)};function Zt(g,I,B){g.transparent===!0&&g.side===Ve&&g.forceSinglePass===!1?(g.side=we,g.needsUpdate=!0,Ci(g,I,B),g.side=vn,g.needsUpdate=!0,Ci(g,I,B),g.side=Ve):Ci(g,I,B)}this.compile=function(g,I,B=null){B===null&&(B=g),h=ot.get(B),h.init(I),T.push(h),B.traverseVisible(function(N){N.isLight&&N.layers.test(I.layers)&&(h.pushLight(N),N.castShadow&&h.pushShadow(N))}),g!==B&&g.traverseVisible(function(N){N.isLight&&N.layers.test(I.layers)&&(h.pushLight(N),N.castShadow&&h.pushShadow(N))}),h.setupLights();const z=new Set;return g.traverse(function(N){if(!(N.isMesh||N.isPoints||N.isLine||N.isSprite))return;const tt=N.material;if(tt)if(Array.isArray(tt))for(let ht=0;ht<tt.length;ht++){const _t=tt[ht];Zt(_t,B,N),z.add(_t)}else Zt(tt,B,N),z.add(tt)}),h=T.pop(),z},this.compileAsync=function(g,I,B=null){const z=this.compile(g,I,B);return new Promise(N=>{function tt(){if(z.forEach(function(ht){bt.get(ht).currentProgram.isReady()&&z.delete(ht)}),z.size===0){N(g);return}setTimeout(tt,10)}Gt.get("KHR_parallel_shader_compile")!==null?tt():setTimeout(tt,10)})};let Oe=null;function Ze(g){Oe&&Oe(g)}function na(){Mn.stop()}function ia(){Mn.start()}const Mn=new ko;Mn.setAnimationLoop(Ze),typeof self<"u"&&Mn.setContext(self),this.setAnimationLoop=function(g){Oe=g,J.setAnimationLoop(g),g===null?Mn.stop():Mn.start()},J.addEventListener("sessionstart",na),J.addEventListener("sessionend",ia),this.render=function(g,I){if(I!==void 0&&I.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(L===!0)return;if(g.matrixWorldAutoUpdate===!0&&g.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),J.enabled===!0&&J.isPresenting===!0&&(J.cameraAutoUpdate===!0&&J.updateCamera(I),I=J.getCamera()),g.isScene===!0&&g.onBeforeRender(E,g,I,D),h=ot.get(g,T.length),h.init(I),T.push(h),Mt.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),W.setFromProjectionMatrix(Mt),vt=this.localClippingEnabled,et=xt.init(this.clippingPlanes,vt),p=St.get(g,b.length),p.init(),b.push(p),J.enabled===!0&&J.isPresenting===!0){const tt=E.xr.getDepthSensingMesh();tt!==null&&gs(tt,I,-1/0,E.sortObjects)}gs(g,I,0,E.sortObjects),p.finish(),E.sortObjects===!0&&p.sort(rt,ut),Ft=J.enabled===!1||J.isPresenting===!1||J.hasDepthSensing()===!1,Ft&&$.addToRenderList(p,g),this.info.render.frame++,et===!0&&xt.beginShadows();const B=h.state.shadowsArray;Et.render(B,g,I),et===!0&&xt.endShadows(),this.info.autoReset===!0&&this.info.reset();const z=p.opaque,N=p.transmissive;if(h.setupLights(),I.isArrayCamera){const tt=I.cameras;if(N.length>0)for(let ht=0,_t=tt.length;ht<_t;ht++){const ft=tt[ht];ra(z,N,g,ft)}Ft&&$.render(g);for(let ht=0,_t=tt.length;ht<_t;ht++){const ft=tt[ht];sa(p,g,ft,ft.viewport)}}else N.length>0&&ra(z,N,g,I),Ft&&$.render(g),sa(p,g,I);D!==null&&w===0&&(zt.updateMultisampleRenderTarget(D),zt.updateRenderTargetMipmap(D)),g.isScene===!0&&g.onAfterRender(E,g,I),It.resetDefaultState(),S=-1,x=null,T.pop(),T.length>0?(h=T[T.length-1],et===!0&&xt.setGlobalState(E.clippingPlanes,h.state.camera)):h=null,b.pop(),b.length>0?p=b[b.length-1]:p=null};function gs(g,I,B,z){if(g.visible===!1)return;if(g.layers.test(I.layers)){if(g.isGroup)B=g.renderOrder;else if(g.isLOD)g.autoUpdate===!0&&g.update(I);else if(g.isLight)h.pushLight(g),g.castShadow&&h.pushShadow(g);else if(g.isSprite){if(!g.frustumCulled||W.intersectsSprite(g)){z&&at.setFromMatrixPosition(g.matrixWorld).applyMatrix4(Mt);const ht=q.update(g),_t=g.material;_t.visible&&p.push(g,ht,_t,B,at.z,null)}}else if((g.isMesh||g.isLine||g.isPoints)&&(!g.frustumCulled||W.intersectsObject(g))){const ht=q.update(g),_t=g.material;if(z&&(g.boundingSphere!==void 0?(g.boundingSphere===null&&g.computeBoundingSphere(),at.copy(g.boundingSphere.center)):(ht.boundingSphere===null&&ht.computeBoundingSphere(),at.copy(ht.boundingSphere.center)),at.applyMatrix4(g.matrixWorld).applyMatrix4(Mt)),Array.isArray(_t)){const ft=ht.groups;for(let Dt=0,Ut=ft.length;Dt<Ut;Dt++){const Tt=ft[Dt],Wt=_t[Tt.materialIndex];Wt&&Wt.visible&&p.push(g,ht,Wt,B,at.z,Tt)}}else _t.visible&&p.push(g,ht,_t,B,at.z,null)}}const tt=g.children;for(let ht=0,_t=tt.length;ht<_t;ht++)gs(tt[ht],I,B,z)}function sa(g,I,B,z){const N=g.opaque,tt=g.transmissive,ht=g.transparent;h.setupLightsView(B),et===!0&&xt.setGlobalState(E.clippingPlanes,B),z&&gt.viewport(C.copy(z)),N.length>0&&Ri(N,I,B),tt.length>0&&Ri(tt,I,B),ht.length>0&&Ri(ht,I,B),gt.buffers.depth.setTest(!0),gt.buffers.depth.setMask(!0),gt.buffers.color.setMask(!0),gt.setPolygonOffset(!1)}function ra(g,I,B,z){if((B.isScene===!0?B.overrideMaterial:null)!==null)return;h.state.transmissionRenderTarget[z.id]===void 0&&(h.state.transmissionRenderTarget[z.id]=new Nn(1,1,{generateMipmaps:!0,type:Gt.has("EXT_color_buffer_half_float")||Gt.has("EXT_color_buffer_float")?Ti:Ke,minFilter:Ln,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Yt.workingColorSpace}));const tt=h.state.transmissionRenderTarget[z.id],ht=z.viewport||C;tt.setSize(ht.z*E.transmissionResolutionScale,ht.w*E.transmissionResolutionScale);const _t=E.getRenderTarget(),ft=E.getActiveCubeFace(),Dt=E.getActiveMipmapLevel();E.setRenderTarget(tt),E.getClearColor(X),Y=E.getClearAlpha(),Y<1&&E.setClearColor(16777215,.5),E.clear(),Ft&&$.render(B);const Ut=E.toneMapping;E.toneMapping=gn;const Tt=z.viewport;if(z.viewport!==void 0&&(z.viewport=void 0),h.setupLightsView(z),et===!0&&xt.setGlobalState(E.clippingPlanes,z),Ri(g,B,z),zt.updateMultisampleRenderTarget(tt),zt.updateRenderTargetMipmap(tt),Gt.has("WEBGL_multisampled_render_to_texture")===!1){let Wt=!1;for(let $t=0,le=I.length;$t<le;$t++){const ie=I[$t],ee=ie.object,At=ie.geometry,oe=ie.material,qt=ie.group;if(oe.side===Ve&&ee.layers.test(z.layers)){const Re=oe.side;oe.side=we,oe.needsUpdate=!0,aa(ee,B,z,At,oe,qt),oe.side=Re,oe.needsUpdate=!0,Wt=!0}}Wt===!0&&(zt.updateMultisampleRenderTarget(tt),zt.updateRenderTargetMipmap(tt))}E.setRenderTarget(_t,ft,Dt),E.setClearColor(X,Y),Tt!==void 0&&(z.viewport=Tt),E.toneMapping=Ut}function Ri(g,I,B){const z=I.isScene===!0?I.overrideMaterial:null;for(let N=0,tt=g.length;N<tt;N++){const ht=g[N],_t=ht.object,ft=ht.geometry,Dt=ht.group;let Ut=ht.material;Ut.allowOverride===!0&&z!==null&&(Ut=z),_t.layers.test(B.layers)&&aa(_t,I,B,ft,Ut,Dt)}}function aa(g,I,B,z,N,tt){g.onBeforeRender(E,I,B,z,N,tt),g.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,g.matrixWorld),g.normalMatrix.getNormalMatrix(g.modelViewMatrix),N.onBeforeRender(E,I,B,z,g,tt),N.transparent===!0&&N.side===Ve&&N.forceSinglePass===!1?(N.side=we,N.needsUpdate=!0,E.renderBufferDirect(B,I,z,N,g,tt),N.side=vn,N.needsUpdate=!0,E.renderBufferDirect(B,I,z,N,g,tt),N.side=Ve):E.renderBufferDirect(B,I,z,N,g,tt),g.onAfterRender(E,I,B,z,N,tt)}function Ci(g,I,B){I.isScene!==!0&&(I=Pt);const z=bt.get(g),N=h.state.lights,tt=h.state.shadowsArray,ht=N.state.version,_t=j.getParameters(g,N.state,tt,I,B),ft=j.getProgramCacheKey(_t);let Dt=z.programs;z.environment=g.isMeshStandardMaterial?I.environment:null,z.fog=I.fog,z.envMap=(g.isMeshStandardMaterial?y:he).get(g.envMap||z.environment),z.envMapRotation=z.environment!==null&&g.envMap===null?I.environmentRotation:g.envMapRotation,Dt===void 0&&(g.addEventListener("dispose",mt),Dt=new Map,z.programs=Dt);let Ut=Dt.get(ft);if(Ut!==void 0){if(z.currentProgram===Ut&&z.lightsStateVersion===ht)return la(g,_t),Ut}else _t.uniforms=j.getUniforms(g),g.onBeforeCompile(_t,E),Ut=j.acquireProgram(_t,ft),Dt.set(ft,Ut),z.uniforms=_t.uniforms;const Tt=z.uniforms;return(!g.isShaderMaterial&&!g.isRawShaderMaterial||g.clipping===!0)&&(Tt.clippingPlanes=xt.uniform),la(g,_t),z.needsLights=$o(g),z.lightsStateVersion=ht,z.needsLights&&(Tt.ambientLightColor.value=N.state.ambient,Tt.lightProbe.value=N.state.probe,Tt.directionalLights.value=N.state.directional,Tt.directionalLightShadows.value=N.state.directionalShadow,Tt.spotLights.value=N.state.spot,Tt.spotLightShadows.value=N.state.spotShadow,Tt.rectAreaLights.value=N.state.rectArea,Tt.ltc_1.value=N.state.rectAreaLTC1,Tt.ltc_2.value=N.state.rectAreaLTC2,Tt.pointLights.value=N.state.point,Tt.pointLightShadows.value=N.state.pointShadow,Tt.hemisphereLights.value=N.state.hemi,Tt.directionalShadowMap.value=N.state.directionalShadowMap,Tt.directionalShadowMatrix.value=N.state.directionalShadowMatrix,Tt.spotShadowMap.value=N.state.spotShadowMap,Tt.spotLightMatrix.value=N.state.spotLightMatrix,Tt.spotLightMap.value=N.state.spotLightMap,Tt.pointShadowMap.value=N.state.pointShadowMap,Tt.pointShadowMatrix.value=N.state.pointShadowMatrix),z.currentProgram=Ut,z.uniformsList=null,Ut}function oa(g){if(g.uniformsList===null){const I=g.currentProgram.getUniforms();g.uniformsList=os.seqWithValue(I.seq,g.uniforms)}return g.uniformsList}function la(g,I){const B=bt.get(g);B.outputColorSpace=I.outputColorSpace,B.batching=I.batching,B.batchingColor=I.batchingColor,B.instancing=I.instancing,B.instancingColor=I.instancingColor,B.instancingMorph=I.instancingMorph,B.skinning=I.skinning,B.morphTargets=I.morphTargets,B.morphNormals=I.morphNormals,B.morphColors=I.morphColors,B.morphTargetsCount=I.morphTargetsCount,B.numClippingPlanes=I.numClippingPlanes,B.numIntersection=I.numClipIntersection,B.vertexAlphas=I.vertexAlphas,B.vertexTangents=I.vertexTangents,B.toneMapping=I.toneMapping}function jo(g,I,B,z,N){I.isScene!==!0&&(I=Pt),zt.resetTextureUnits();const tt=I.fog,ht=z.isMeshStandardMaterial?I.environment:null,_t=D===null?E.outputColorSpace:D.isXRRenderTarget===!0?D.texture.colorSpace:oi,ft=(z.isMeshStandardMaterial?y:he).get(z.envMap||ht),Dt=z.vertexColors===!0&&!!B.attributes.color&&B.attributes.color.itemSize===4,Ut=!!B.attributes.tangent&&(!!z.normalMap||z.anisotropy>0),Tt=!!B.morphAttributes.position,Wt=!!B.morphAttributes.normal,$t=!!B.morphAttributes.color;let le=gn;z.toneMapped&&(D===null||D.isXRRenderTarget===!0)&&(le=E.toneMapping);const ie=B.morphAttributes.position||B.morphAttributes.normal||B.morphAttributes.color,ee=ie!==void 0?ie.length:0,At=bt.get(z),oe=h.state.lights;if(et===!0&&(vt===!0||g!==x)){const xe=g===x&&z.id===S;xt.setState(z,g,xe)}let qt=!1;z.version===At.__version?(At.needsLights&&At.lightsStateVersion!==oe.state.version||At.outputColorSpace!==_t||N.isBatchedMesh&&At.batching===!1||!N.isBatchedMesh&&At.batching===!0||N.isBatchedMesh&&At.batchingColor===!0&&N.colorTexture===null||N.isBatchedMesh&&At.batchingColor===!1&&N.colorTexture!==null||N.isInstancedMesh&&At.instancing===!1||!N.isInstancedMesh&&At.instancing===!0||N.isSkinnedMesh&&At.skinning===!1||!N.isSkinnedMesh&&At.skinning===!0||N.isInstancedMesh&&At.instancingColor===!0&&N.instanceColor===null||N.isInstancedMesh&&At.instancingColor===!1&&N.instanceColor!==null||N.isInstancedMesh&&At.instancingMorph===!0&&N.morphTexture===null||N.isInstancedMesh&&At.instancingMorph===!1&&N.morphTexture!==null||At.envMap!==ft||z.fog===!0&&At.fog!==tt||At.numClippingPlanes!==void 0&&(At.numClippingPlanes!==xt.numPlanes||At.numIntersection!==xt.numIntersection)||At.vertexAlphas!==Dt||At.vertexTangents!==Ut||At.morphTargets!==Tt||At.morphNormals!==Wt||At.morphColors!==$t||At.toneMapping!==le||At.morphTargetsCount!==ee)&&(qt=!0):(qt=!0,At.__version=z.version);let Re=At.currentProgram;qt===!0&&(Re=Ci(z,I,N));let On=!1,Ce=!1,ui=!1;const re=Re.getUniforms(),Ue=At.uniforms;if(gt.useProgram(Re.program)&&(On=!0,Ce=!0,ui=!0),z.id!==S&&(S=z.id,Ce=!0),On||x!==g){gt.buffers.depth.getReversed()?(lt.copy(g.projectionMatrix),Xl(lt),ql(lt),re.setValue(A,"projectionMatrix",lt)):re.setValue(A,"projectionMatrix",g.projectionMatrix),re.setValue(A,"viewMatrix",g.matrixWorldInverse);const ye=re.map.cameraPosition;ye!==void 0&&ye.setValue(A,nt.setFromMatrixPosition(g.matrixWorld)),jt.logarithmicDepthBuffer&&re.setValue(A,"logDepthBufFC",2/(Math.log(g.far+1)/Math.LN2)),(z.isMeshPhongMaterial||z.isMeshToonMaterial||z.isMeshLambertMaterial||z.isMeshBasicMaterial||z.isMeshStandardMaterial||z.isShaderMaterial)&&re.setValue(A,"isOrthographic",g.isOrthographicCamera===!0),x!==g&&(x=g,Ce=!0,ui=!0)}if(N.isSkinnedMesh){re.setOptional(A,N,"bindMatrix"),re.setOptional(A,N,"bindMatrixInverse");const xe=N.skeleton;xe&&(xe.boneTexture===null&&xe.computeBoneTexture(),re.setValue(A,"boneTexture",xe.boneTexture,zt))}N.isBatchedMesh&&(re.setOptional(A,N,"batchingTexture"),re.setValue(A,"batchingTexture",N._matricesTexture,zt),re.setOptional(A,N,"batchingIdTexture"),re.setValue(A,"batchingIdTexture",N._indirectTexture,zt),re.setOptional(A,N,"batchingColorTexture"),N._colorsTexture!==null&&re.setValue(A,"batchingColorTexture",N._colorsTexture,zt));const Ie=B.morphAttributes;if((Ie.position!==void 0||Ie.normal!==void 0||Ie.color!==void 0)&&dt.update(N,B,Re),(Ce||At.receiveShadow!==N.receiveShadow)&&(At.receiveShadow=N.receiveShadow,re.setValue(A,"receiveShadow",N.receiveShadow)),z.isMeshGouraudMaterial&&z.envMap!==null&&(Ue.envMap.value=ft,Ue.flipEnvMap.value=ft.isCubeTexture&&ft.isRenderTargetTexture===!1?-1:1),z.isMeshStandardMaterial&&z.envMap===null&&I.environment!==null&&(Ue.envMapIntensity.value=I.environmentIntensity),Ce&&(re.setValue(A,"toneMappingExposure",E.toneMappingExposure),At.needsLights&&Zo(Ue,ui),tt&&z.fog===!0&&G.refreshFogUniforms(Ue,tt),G.refreshMaterialUniforms(Ue,z,V,Z,h.state.transmissionRenderTarget[g.id]),os.upload(A,oa(At),Ue,zt)),z.isShaderMaterial&&z.uniformsNeedUpdate===!0&&(os.upload(A,oa(At),Ue,zt),z.uniformsNeedUpdate=!1),z.isSpriteMaterial&&re.setValue(A,"center",N.center),re.setValue(A,"modelViewMatrix",N.modelViewMatrix),re.setValue(A,"normalMatrix",N.normalMatrix),re.setValue(A,"modelMatrix",N.matrixWorld),z.isShaderMaterial||z.isRawShaderMaterial){const xe=z.uniformsGroups;for(let ye=0,vs=xe.length;ye<vs;ye++){const Sn=xe[ye];P.update(Sn,Re),P.bind(Sn,Re)}}return Re}function Zo(g,I){g.ambientLightColor.needsUpdate=I,g.lightProbe.needsUpdate=I,g.directionalLights.needsUpdate=I,g.directionalLightShadows.needsUpdate=I,g.pointLights.needsUpdate=I,g.pointLightShadows.needsUpdate=I,g.spotLights.needsUpdate=I,g.spotLightShadows.needsUpdate=I,g.rectAreaLights.needsUpdate=I,g.hemisphereLights.needsUpdate=I}function $o(g){return g.isMeshLambertMaterial||g.isMeshToonMaterial||g.isMeshPhongMaterial||g.isMeshStandardMaterial||g.isShadowMaterial||g.isShaderMaterial&&g.lights===!0}this.getActiveCubeFace=function(){return R},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return D},this.setRenderTargetTextures=function(g,I,B){const z=bt.get(g);z.__autoAllocateDepthBuffer=g.resolveDepthBuffer===!1,z.__autoAllocateDepthBuffer===!1&&(z.__useRenderToTexture=!1),bt.get(g.texture).__webglTexture=I,bt.get(g.depthTexture).__webglTexture=z.__autoAllocateDepthBuffer?void 0:B,z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(g,I){const B=bt.get(g);B.__webglFramebuffer=I,B.__useDefaultFramebuffer=I===void 0};const Jo=A.createFramebuffer();this.setRenderTarget=function(g,I=0,B=0){D=g,R=I,w=B;let z=!0,N=null,tt=!1,ht=!1;if(g){const ft=bt.get(g);if(ft.__useDefaultFramebuffer!==void 0)gt.bindFramebuffer(A.FRAMEBUFFER,null),z=!1;else if(ft.__webglFramebuffer===void 0)zt.setupRenderTarget(g);else if(ft.__hasExternalTextures)zt.rebindTextures(g,bt.get(g.texture).__webglTexture,bt.get(g.depthTexture).__webglTexture);else if(g.depthBuffer){const Tt=g.depthTexture;if(ft.__boundDepthTexture!==Tt){if(Tt!==null&&bt.has(Tt)&&(g.width!==Tt.image.width||g.height!==Tt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");zt.setupDepthRenderbuffer(g)}}const Dt=g.texture;(Dt.isData3DTexture||Dt.isDataArrayTexture||Dt.isCompressedArrayTexture)&&(ht=!0);const Ut=bt.get(g).__webglFramebuffer;g.isWebGLCubeRenderTarget?(Array.isArray(Ut[I])?N=Ut[I][B]:N=Ut[I],tt=!0):g.samples>0&&zt.useMultisampledRTT(g)===!1?N=bt.get(g).__webglMultisampledFramebuffer:Array.isArray(Ut)?N=Ut[B]:N=Ut,C.copy(g.viewport),H.copy(g.scissor),O=g.scissorTest}else C.copy(yt).multiplyScalar(V).floor(),H.copy(Nt).multiplyScalar(V).floor(),O=Kt;if(B!==0&&(N=Jo),gt.bindFramebuffer(A.FRAMEBUFFER,N)&&z&&gt.drawBuffers(g,N),gt.viewport(C),gt.scissor(H),gt.setScissorTest(O),tt){const ft=bt.get(g.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_CUBE_MAP_POSITIVE_X+I,ft.__webglTexture,B)}else if(ht){const ft=bt.get(g.texture),Dt=I;A.framebufferTextureLayer(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,ft.__webglTexture,B,Dt)}else if(g!==null&&B!==0){const ft=bt.get(g.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,ft.__webglTexture,B)}S=-1},this.readRenderTargetPixels=function(g,I,B,z,N,tt,ht,_t=0){if(!(g&&g.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ft=bt.get(g).__webglFramebuffer;if(g.isWebGLCubeRenderTarget&&ht!==void 0&&(ft=ft[ht]),ft){gt.bindFramebuffer(A.FRAMEBUFFER,ft);try{const Dt=g.textures[_t],Ut=Dt.format,Tt=Dt.type;if(!jt.textureFormatReadable(Ut)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!jt.textureTypeReadable(Tt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=g.width-z&&B>=0&&B<=g.height-N&&(g.textures.length>1&&A.readBuffer(A.COLOR_ATTACHMENT0+_t),A.readPixels(I,B,z,N,it.convert(Ut),it.convert(Tt),tt))}finally{const Dt=D!==null?bt.get(D).__webglFramebuffer:null;gt.bindFramebuffer(A.FRAMEBUFFER,Dt)}}},this.readRenderTargetPixelsAsync=async function(g,I,B,z,N,tt,ht,_t=0){if(!(g&&g.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ft=bt.get(g).__webglFramebuffer;if(g.isWebGLCubeRenderTarget&&ht!==void 0&&(ft=ft[ht]),ft)if(I>=0&&I<=g.width-z&&B>=0&&B<=g.height-N){gt.bindFramebuffer(A.FRAMEBUFFER,ft);const Dt=g.textures[_t],Ut=Dt.format,Tt=Dt.type;if(!jt.textureFormatReadable(Ut))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!jt.textureTypeReadable(Tt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Wt=A.createBuffer();A.bindBuffer(A.PIXEL_PACK_BUFFER,Wt),A.bufferData(A.PIXEL_PACK_BUFFER,tt.byteLength,A.STREAM_READ),g.textures.length>1&&A.readBuffer(A.COLOR_ATTACHMENT0+_t),A.readPixels(I,B,z,N,it.convert(Ut),it.convert(Tt),0);const $t=D!==null?bt.get(D).__webglFramebuffer:null;gt.bindFramebuffer(A.FRAMEBUFFER,$t);const le=A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE,0);return A.flush(),await Wl(A,le,4),A.bindBuffer(A.PIXEL_PACK_BUFFER,Wt),A.getBufferSubData(A.PIXEL_PACK_BUFFER,0,tt),A.deleteBuffer(Wt),A.deleteSync(le),tt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(g,I=null,B=0){const z=Math.pow(2,-B),N=Math.floor(g.image.width*z),tt=Math.floor(g.image.height*z),ht=I!==null?I.x:0,_t=I!==null?I.y:0;zt.setTexture2D(g,0),A.copyTexSubImage2D(A.TEXTURE_2D,B,0,0,ht,_t,N,tt),gt.unbindTexture()};const Qo=A.createFramebuffer(),tl=A.createFramebuffer();this.copyTextureToTexture=function(g,I,B=null,z=null,N=0,tt=null){tt===null&&(N!==0?(ni("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),tt=N,N=0):tt=0);let ht,_t,ft,Dt,Ut,Tt,Wt,$t,le;const ie=g.isCompressedTexture?g.mipmaps[tt]:g.image;if(B!==null)ht=B.max.x-B.min.x,_t=B.max.y-B.min.y,ft=B.isBox3?B.max.z-B.min.z:1,Dt=B.min.x,Ut=B.min.y,Tt=B.isBox3?B.min.z:0;else{const Ie=Math.pow(2,-N);ht=Math.floor(ie.width*Ie),_t=Math.floor(ie.height*Ie),g.isDataArrayTexture?ft=ie.depth:g.isData3DTexture?ft=Math.floor(ie.depth*Ie):ft=1,Dt=0,Ut=0,Tt=0}z!==null?(Wt=z.x,$t=z.y,le=z.z):(Wt=0,$t=0,le=0);const ee=it.convert(I.format),At=it.convert(I.type);let oe;I.isData3DTexture?(zt.setTexture3D(I,0),oe=A.TEXTURE_3D):I.isDataArrayTexture||I.isCompressedArrayTexture?(zt.setTexture2DArray(I,0),oe=A.TEXTURE_2D_ARRAY):(zt.setTexture2D(I,0),oe=A.TEXTURE_2D),A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,I.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,I.unpackAlignment);const qt=A.getParameter(A.UNPACK_ROW_LENGTH),Re=A.getParameter(A.UNPACK_IMAGE_HEIGHT),On=A.getParameter(A.UNPACK_SKIP_PIXELS),Ce=A.getParameter(A.UNPACK_SKIP_ROWS),ui=A.getParameter(A.UNPACK_SKIP_IMAGES);A.pixelStorei(A.UNPACK_ROW_LENGTH,ie.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,ie.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Dt),A.pixelStorei(A.UNPACK_SKIP_ROWS,Ut),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Tt);const re=g.isDataArrayTexture||g.isData3DTexture,Ue=I.isDataArrayTexture||I.isData3DTexture;if(g.isDepthTexture){const Ie=bt.get(g),xe=bt.get(I),ye=bt.get(Ie.__renderTarget),vs=bt.get(xe.__renderTarget);gt.bindFramebuffer(A.READ_FRAMEBUFFER,ye.__webglFramebuffer),gt.bindFramebuffer(A.DRAW_FRAMEBUFFER,vs.__webglFramebuffer);for(let Sn=0;Sn<ft;Sn++)re&&(A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,bt.get(g).__webglTexture,N,Tt+Sn),A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,bt.get(I).__webglTexture,tt,le+Sn)),A.blitFramebuffer(Dt,Ut,ht,_t,Wt,$t,ht,_t,A.DEPTH_BUFFER_BIT,A.NEAREST);gt.bindFramebuffer(A.READ_FRAMEBUFFER,null),gt.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else if(N!==0||g.isRenderTargetTexture||bt.has(g)){const Ie=bt.get(g),xe=bt.get(I);gt.bindFramebuffer(A.READ_FRAMEBUFFER,Qo),gt.bindFramebuffer(A.DRAW_FRAMEBUFFER,tl);for(let ye=0;ye<ft;ye++)re?A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Ie.__webglTexture,N,Tt+ye):A.framebufferTexture2D(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Ie.__webglTexture,N),Ue?A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,xe.__webglTexture,tt,le+ye):A.framebufferTexture2D(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,xe.__webglTexture,tt),N!==0?A.blitFramebuffer(Dt,Ut,ht,_t,Wt,$t,ht,_t,A.COLOR_BUFFER_BIT,A.NEAREST):Ue?A.copyTexSubImage3D(oe,tt,Wt,$t,le+ye,Dt,Ut,ht,_t):A.copyTexSubImage2D(oe,tt,Wt,$t,Dt,Ut,ht,_t);gt.bindFramebuffer(A.READ_FRAMEBUFFER,null),gt.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else Ue?g.isDataTexture||g.isData3DTexture?A.texSubImage3D(oe,tt,Wt,$t,le,ht,_t,ft,ee,At,ie.data):I.isCompressedArrayTexture?A.compressedTexSubImage3D(oe,tt,Wt,$t,le,ht,_t,ft,ee,ie.data):A.texSubImage3D(oe,tt,Wt,$t,le,ht,_t,ft,ee,At,ie):g.isDataTexture?A.texSubImage2D(A.TEXTURE_2D,tt,Wt,$t,ht,_t,ee,At,ie.data):g.isCompressedTexture?A.compressedTexSubImage2D(A.TEXTURE_2D,tt,Wt,$t,ie.width,ie.height,ee,ie.data):A.texSubImage2D(A.TEXTURE_2D,tt,Wt,$t,ht,_t,ee,At,ie);A.pixelStorei(A.UNPACK_ROW_LENGTH,qt),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,Re),A.pixelStorei(A.UNPACK_SKIP_PIXELS,On),A.pixelStorei(A.UNPACK_SKIP_ROWS,Ce),A.pixelStorei(A.UNPACK_SKIP_IMAGES,ui),tt===0&&I.generateMipmaps&&A.generateMipmap(oe),gt.unbindTexture()},this.copyTextureToTexture3D=function(g,I,B=null,z=null,N=0){return ni('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(g,I,B,z,N)},this.initRenderTarget=function(g){bt.get(g).__webglFramebuffer===void 0&&zt.setupRenderTarget(g)},this.initTexture=function(g){g.isCubeTexture?zt.setTextureCube(g,0):g.isData3DTexture?zt.setTexture3D(g,0):g.isDataArrayTexture||g.isCompressedArrayTexture?zt.setTexture2DArray(g,0):zt.setTexture2D(g,0),gt.unbindTexture()},this.resetState=function(){R=0,w=0,D=null,gt.reset(),It.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return an}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=Yt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Yt._getUnpackColorSpace()}}const uo={type:"change"},ea={type:"start"},Ko={type:"end"},ts=new jr,fo=new pn,mp=Math.cos(70*Gl.DEG2RAD),ue=new U,be=2*Math.PI,Qt={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Js=1e-6;class _p extends Pc{constructor(t,e=null){super(t,e),this.state=Qt.NONE,this.target=new U,this.cursor=new U,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:ti.ROTATE,MIDDLE:ti.DOLLY,RIGHT:ti.PAN},this.touches={ONE:Jn.ROTATE,TWO:Jn.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new U,this._lastQuaternion=new In,this._lastTargetPosition=new U,this._quat=new In().setFromUnitVectors(t.up,new U(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new za,this._sphericalDelta=new za,this._scale=1,this._panOffset=new U,this._rotateStart=new wt,this._rotateEnd=new wt,this._rotateDelta=new wt,this._panStart=new wt,this._panEnd=new wt,this._panDelta=new wt,this._dollyStart=new wt,this._dollyEnd=new wt,this._dollyDelta=new wt,this._dollyDirection=new U,this._mouse=new wt,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=vp.bind(this),this._onPointerDown=gp.bind(this),this._onPointerUp=xp.bind(this),this._onContextMenu=Ap.bind(this),this._onMouseWheel=Ep.bind(this),this._onKeyDown=yp.bind(this),this._onTouchStart=Tp.bind(this),this._onTouchMove=bp.bind(this),this._onMouseDown=Mp.bind(this),this._onMouseMove=Sp.bind(this),this._interceptControlDown=wp.bind(this),this._interceptControlUp=Rp.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(uo),this.update(),this.state=Qt.NONE}update(t=null){const e=this.object.position;ue.copy(e).sub(this.target),ue.applyQuaternion(this._quat),this._spherical.setFromVector3(ue),this.autoRotate&&this.state===Qt.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,s=this.maxAzimuthAngle;isFinite(n)&&isFinite(s)&&(n<-Math.PI?n+=be:n>Math.PI&&(n-=be),s<-Math.PI?s+=be:s>Math.PI&&(s-=be),n<=s?this._spherical.theta=Math.max(n,Math.min(s,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+s)/2?Math.max(n,this._spherical.theta):Math.min(s,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let r=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const a=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),r=a!=this._spherical.radius}if(ue.setFromSpherical(this._spherical),ue.applyQuaternion(this._quatInverse),e.copy(this.target).add(ue),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let a=null;if(this.object.isPerspectiveCamera){const o=ue.length();a=this._clampDistance(o*this._scale);const l=o-a;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),r=!!l}else if(this.object.isOrthographicCamera){const o=new U(this._mouse.x,this._mouse.y,0);o.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),r=l!==this.object.zoom;const c=new U(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(o),this.object.updateMatrixWorld(),a=ue.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;a!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position):(ts.origin.copy(this.object.position),ts.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(ts.direction))<mp?this.object.lookAt(this.target):(fo.setFromNormalAndCoplanarPoint(this.object.up,this.target),ts.intersectPlane(fo,this.target))))}else if(this.object.isOrthographicCamera){const a=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),a!==this.object.zoom&&(this.object.updateProjectionMatrix(),r=!0)}return this._scale=1,this._performCursorZoom=!1,r||this._lastPosition.distanceToSquared(this.object.position)>Js||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Js||this._lastTargetPosition.distanceToSquared(this.target)>Js?(this.dispatchEvent(uo),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?be/60*this.autoRotateSpeed*t:be/60/60*this.autoRotateSpeed}_getZoomScale(t){const e=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,e){ue.setFromMatrixColumn(e,0),ue.multiplyScalar(-t),this._panOffset.add(ue)}_panUp(t,e){this.screenSpacePanning===!0?ue.setFromMatrixColumn(e,1):(ue.setFromMatrixColumn(e,0),ue.crossVectors(this.object.up,ue)),ue.multiplyScalar(t),this._panOffset.add(ue)}_pan(t,e){const n=this.domElement;if(this.object.isPerspectiveCamera){const s=this.object.position;ue.copy(s).sub(this.target);let r=ue.length();r*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*r/n.clientHeight,this.object.matrix),this._panUp(2*e*r/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const n=this.domElement.getBoundingClientRect(),s=t-n.left,r=e-n.top,a=n.width,o=n.height;this._mouse.x=s/a*2-1,this._mouse.y=-(r/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(be*this._rotateDelta.x/e.clientHeight),this._rotateUp(be*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let e=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(be*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-be*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(be*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-be*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._rotateStart.set(n,s)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panStart.set(n,s)}}_handleTouchStartDolly(t){const e=this._getSecondPointerPosition(t),n=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(n*n+s*s);this._dollyStart.set(0,r)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{const n=this._getSecondPointerPosition(t),s=.5*(t.pageX+n.x),r=.5*(t.pageY+n.y);this._rotateEnd.set(s,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(be*this._rotateDelta.x/e.clientHeight),this._rotateUp(be*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panEnd.set(n,s)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){const e=this._getSecondPointerPosition(t),n=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(n*n+s*s);this._dollyEnd.set(0,r),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const a=(t.pageX+e.x)*.5,o=(t.pageY+e.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(t){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId)return!0;return!1}_trackPointer(t){let e=this._pointerPositions[t.pointerId];e===void 0&&(e=new wt,this._pointerPositions[t.pointerId]=e),e.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){const e=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(t){const e=t.deltaMode,n={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(e){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}}function gp(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(i)&&(this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i)))}function vp(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function xp(i){switch(this._removePointer(i),this._pointers.length){case 0:this.domElement.releasePointerCapture(i.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Ko),this.state=Qt.NONE;break;case 1:const t=this._pointers[0],e=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:e.x,pageY:e.y});break}}function Mp(i){let t;switch(i.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case ti.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(i),this.state=Qt.DOLLY;break;case ti.ROTATE:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=Qt.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=Qt.ROTATE}break;case ti.PAN:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=Qt.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=Qt.PAN}break;default:this.state=Qt.NONE}this.state!==Qt.NONE&&this.dispatchEvent(ea)}function Sp(i){switch(this.state){case Qt.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(i);break;case Qt.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(i);break;case Qt.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(i);break}}function Ep(i){this.enabled===!1||this.enableZoom===!1||this.state!==Qt.NONE||(i.preventDefault(),this.dispatchEvent(ea),this._handleMouseWheel(this._customWheelEvent(i)),this.dispatchEvent(Ko))}function yp(i){this.enabled!==!1&&this._handleKeyDown(i)}function Tp(i){switch(this._trackPointer(i),this._pointers.length){case 1:switch(this.touches.ONE){case Jn.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(i),this.state=Qt.TOUCH_ROTATE;break;case Jn.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(i),this.state=Qt.TOUCH_PAN;break;default:this.state=Qt.NONE}break;case 2:switch(this.touches.TWO){case Jn.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(i),this.state=Qt.TOUCH_DOLLY_PAN;break;case Jn.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(i),this.state=Qt.TOUCH_DOLLY_ROTATE;break;default:this.state=Qt.NONE}break;default:this.state=Qt.NONE}this.state!==Qt.NONE&&this.dispatchEvent(ea)}function bp(i){switch(this._trackPointer(i),this.state){case Qt.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(i),this.update();break;case Qt.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(i),this.update();break;case Qt.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(i),this.update();break;case Qt.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(i),this.update();break;default:this.state=Qt.NONE}}function Ap(i){this.enabled!==!1&&i.preventDefault()}function wp(i){i.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function Rp(i){i.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const po=document.querySelector("#scene"),Cp=document.querySelector("#webglFallback"),Pp=document.querySelector(".hero");let sn;try{sn=new pp({canvas:po,antialias:!0,alpha:!1})}catch(i){po.hidden=!0,Cp.hidden=!1,console.error("WebGL initialization failed",i)}if(sn){let vt=function(nt){const at=s[r].colors,Pt=u.createLinearGradient(0,0,0,d.height);Pt.addColorStop(0,at[0]),Pt.addColorStop(.28,at[1]),Pt.addColorStop(.62,at[2]),Pt.addColorStop(.82,at[3]),Pt.addColorStop(1,at[4]),u.fillStyle=Pt,u.fillRect(0,0,d.width,d.height),u.globalCompositeOperation="screen";for(let Ft=0;Ft<24;Ft+=1){const Lt=d.width*(.5+.46*Math.sin(Ft*2.17+nt*15e-5)),A=150+Ft/24*500+50*Math.sin(Ft+nt*22e-5),se=56+Ft%5*17+a*20,Gt=u.createRadialGradient(Lt,A,8,Lt,A,se);Gt.addColorStop(0,at[(Ft+2)%at.length]),Gt.addColorStop(1,"rgba(255,255,255,0)"),u.fillStyle=Gt,u.fillRect(Lt-se,A-se,se*2,se*2)}u.globalCompositeOperation="multiply",u.fillStyle="rgba(18, 10, 12, .58)",u.fillRect(0,0,d.width,124),u.fillStyle="rgba(40, 18, 15, .45)",u.fillRect(0,640,d.width,128),u.strokeStyle=r>=2?"rgba(88, 74, 61, .09)":"rgba(242, 174, 118, .17)",u.lineWidth=1.35;for(let Ft=0;Ft<36;Ft+=1){const Lt=Ft*15+7*Math.sin(Ft*1.8);u.beginPath(),u.moveTo(Lt,130),u.bezierCurveTo(Lt-14,285,Lt+16,465,Lt-4,640),u.stroke()}Kt.checked&&(u.globalAlpha=[.25,.32,.48,.58][r],u.imageSmoothingEnabled=!0,u.drawImage(M,0,0,d.width,d.height),u.globalAlpha=1),u.globalCompositeOperation="source-over",f.needsUpdate=!0},lt=function(){const{width:nt,height:at}=Pp.getBoundingClientRect();sn.setSize(nt,at,!1),e.aspect=nt/at,e.updateProjectionMatrix()},Mt=function(nt){c>0&&(a=Math.max(0,(c-nt)/650),nt>=c&&(c=0,a=0,o=!0,Nt.disabled=!1,Nt.removeAttribute("aria-busy"),ut.textContent=`${s[r].name} · 生成完成`)),(o||c>0&&nt-l>=50)&&(vt(nt),o=!1,l=nt),w.rotation.y+=a*.012,k.rotation.y-=7e-4,V.intensity=5.5+a*17+Math.sin(nt*.002)*.7,n.update(),sn.render(t,e),requestAnimationFrame(Mt)};var Dp=vt,Lp=lt,Up=Mt;const i=matchMedia("(max-width: 860px)").matches;sn.setPixelRatio(Math.min(window.devicePixelRatio,i?1.2:1.8)),sn.outputColorSpace=Ae,sn.toneMapping=go,sn.toneMappingExposure=1.08;const t=new gc;t.background=new kt("#101312"),t.fog=new Zr("#101312",9,24);const e=new Le(38,1,.1,100);e.position.set(i?0:-.65,1.45,i?10.8:7.1);const n=new _p(e,sn.domElement);n.enableDamping=!0,n.enablePan=!1,n.minDistance=4.5,n.maxDistance=i?12:9,n.target.set(i?0:-.65,.1,0),n.autoRotate=!0,n.autoRotateSpeed=.45;const s=[{name:"窑变红",status:"窑变红 · 实拍取色",colors:["#150e12","#4b111a","#a3262d","#e2593c","#26131a"]},{name:"玫瑰紫",status:"玫瑰紫 · 蓝紫交融",colors:["#1c1730","#5f315d","#a34f75","#668ea2","#241929"]},{name:"天青釉",status:"天青釉 · 雨过天青",colors:["#173b42","#4f8e94","#a9d0ca","#dce4d5","#2b5962"]},{name:"月白釉",status:"月白釉 · 温润开片",colors:["#65716b","#aeb9ad","#e6e6d8","#c6d8d2","#7f918a"]}];let r=0,a=0,o=!0,l=0,c=0;const d=document.createElement("canvas");d.width=512,d.height=768;const u=d.getContext("2d"),f=new Ec(d);f.colorSpace=Ae,f.wrapS=ls;let m=1907;const v=()=>(m=m*16807%2147483647,(m-1)/2147483646),M=document.createElement("canvas");M.width=384,M.height=576;const p=M.getContext("2d"),h=Array.from({length:300},()=>({x:v()*M.width,y:96+v()*396})),b=new Uint16Array(M.width*M.height);for(let nt=87;nt<501;nt+=1)for(let at=0;at<M.width;at+=1){let Pt=0,Ft=1/0;h.forEach((Lt,A)=>{const se=Math.abs(at-Lt.x),Gt=Math.min(se,M.width-se),jt=nt-Lt.y,gt=Gt*Gt+jt*jt;gt<Ft&&(Pt=A,Ft=gt)}),b[nt*M.width+at]=Pt}const T=p.createImageData(M.width,M.height);for(let nt=87;nt<500;nt+=1)for(let at=0;at<M.width;at+=1){const Pt=nt*M.width+at,Ft=nt*M.width+(at+1)%M.width,Lt=(nt+1)*M.width+at;if(b[Pt]!==b[Ft]||b[Pt]!==b[Lt]){const A=Pt*4;T.data[A]=35,T.data[A+1]=29,T.data[A+2]=25,T.data[A+3]=96}}p.putImageData(T,0,0);const E=new ks({map:f,roughness:.24,clearcoat:1,clearcoatRoughness:.13,iridescence:.2,iridescenceIOR:1.45,side:Ve}),L=new ks({color:s[0].colors[0],roughness:.3,clearcoat:.75,clearcoatRoughness:.18,side:Ve}),R=[[.52,-1.2],[.9,-1.12],[1.22,-.78],[1.43,-.3],[1.5,.23],[1.38,.58],[1.58,.72],[1.57,.84],[1.28,.88],[1.18,.72],[1.16,.48],[1.04,.14],[.82,-.25],[.55,-.52],[.3,-.62]].map(([nt,at])=>new wt(nt,at)),w=new Se(new Jr(R,i?96:128),E);w.position.set(i?0:-.65,.05,0),t.add(w);const D=new Se(new xi(.3,i?64:96),L);D.rotation.x=-Math.PI/2,D.position.set(w.position.x,w.position.y-.62,0),t.add(D);const S=new Se(new xi(.52,i?64:96),L);S.rotation.x=Math.PI/2,S.position.set(w.position.x,w.position.y-1.2,0),t.add(S);const x=new Se(new ds(.72,.82,.15,96),new ks({color:"#221518",roughness:.34,clearcoat:.72}));x.position.set(w.position.x,-1.19,0),t.add(x);const C=new Se(new ds(2.15,2.35,.24,96),new zr({color:"#22231f",roughness:.72}));C.position.set(w.position.x,-1.38,0),t.add(C);const H=new Se(new xi(10,96),new zr({color:"#1b1d1a",roughness:.9}));H.rotation.x=-Math.PI/2,H.position.y=-1.5,t.add(H);const O=new Fe,X=i?120:180,Y=new Float32Array(X*3);for(let nt=0;nt<X;nt+=1)Y[nt*3]=(Math.random()-.5)*11,Y[nt*3+1]=Math.random()*5-1,Y[nt*3+2]=(Math.random()-.5)*8;O.setAttribute("position",new Xe(Y,3));const k=new Sc(O,new zo({color:"#d5aa72",size:.018,transparent:!0,opacity:.42}));t.add(k),t.add(new bc("#f5edda","#16272b",1.5));const Z=new Rc("#fff0d4",3.2);Z.position.set(3.5,5,4.5),t.add(Z);const V=new Ba("#f1d6ae",5.5,8);V.position.set(-3.2,.5,2.8),t.add(V);const rt=new Ba("#78b8bc",12,7);rt.position.set(3,1.4,-1.5),t.add(rt);const ut=document.querySelector("#status"),yt=document.querySelector("#swatches"),Nt=document.querySelector("#fireButton"),Kt=document.querySelector("#crackleToggle"),W=document.querySelector("#compareButton"),et=document.querySelector("#referenceView");Kt.addEventListener("change",()=>{o=!0}),W.addEventListener("click",()=>{const nt=W.getAttribute("aria-pressed")==="true";W.setAttribute("aria-pressed",String(!nt)),W.textContent=nt?"实拍对照":"返回模型",et.classList.toggle("is-active",!nt),et.setAttribute("aria-hidden",String(nt)),n.autoRotate=nt}),s.forEach((nt,at)=>{const Pt=document.createElement("button");Pt.type="button",Pt.className=`swatch${at===0?" active":""}`,Pt.setAttribute("aria-label",nt.name),Pt.title=nt.name,Pt.style.setProperty("--swatch-a",nt.colors[1]),Pt.style.setProperty("--swatch-b",nt.colors[3]),Pt.addEventListener("click",()=>{r=at,o=!0,L.color.set(nt.colors[0]),ut.textContent=nt.status,document.querySelectorAll(".swatch").forEach(Ft=>Ft.classList.remove("active")),Pt.classList.add("active")}),yt.appendChild(Pt)}),Nt.addEventListener("click",()=>{a=1,c=performance.now()+650,o=!0,Nt.disabled=!0,Nt.setAttribute("aria-busy","true"),ut.textContent=`${s[r].name} · 窑火生成中`}),addEventListener("resize",lt),lt(),vt(0),requestAnimationFrame(Mt)}
